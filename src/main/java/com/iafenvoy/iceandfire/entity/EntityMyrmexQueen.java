...
public class EntityMyrmexQueen extends EntityMyrmexBase {
    ...
    public static DefaultAttributeContainer.Builder bakeAttributes() {
        return MobEntity.createMobAttributes()
                ...
                //ATTACK
                .add(EntityAttributes.GENERIC_ATTACK_DAMAGE, IafCommonConfig.INSTANCE.myrmex.baseAttackDamage * 3.5D)
                //FOLLOW RANGE
    ...
    public void tickMovement() {
        ...
        if (!this.getWorld().isClient && this.eggTicks > IafCommonConfig.INSTANCE.myrmex.pregnantTicks && this.getHive() == null || !this.getWorld().isClient && this.getHive() != null && this.getHive().repopulate() && this.eggTicks > IafCommonConfig.INSTANCE.myrmex.pregnantTicks) {
            float radius = -5.25F;
    ...
    public void setConfigurableAttributes() {
        this.getAttributeInstance(EntityAttributes.GENERIC_ATTACK_DAMAGE).setBaseValue(IafCommonConfig.INSTANCE.myrmex.baseAttackDamage * 3.5D);
    }
