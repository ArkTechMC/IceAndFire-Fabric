...
public class IafItemRegistry {
    ...
    public static final CustomArmorMaterial DEATHWORM_0_ARMOR_MATERIAL = new IafArmorMaterial("yellow seathworm", 15, new int[]{2, 5, 7, 3}, 5, SoundEvents.ITEM_ARMOR_EQUIP_LEATHER, 1.5F);
    public static final CustomArmorMaterial DEATHWORM_1_ARMOR_MATERIAL = new IafArmorMaterial("white seathworm", 15, new int[]{2, 5, 7, 3}, 5, SoundEvents.ITEM_ARMOR_EQUIP_LEATHER, 1.5F);
    public static final CustomArmorMaterial DEATHWORM_2_ARMOR_MATERIAL = new IafArmorMaterial("red deathworm", 15, new int[]{2, 5, 7, 3}, 5, SoundEvents.ITEM_ARMOR_EQUIP_LEATHER, 1.5F);
    ...
    public static final CustomToolMaterial FIRE_DRAGONBONE_TOOL_MATERIAL = new CustomToolMaterial("FireDragonbone", 3, 2000, 5.5F, 10F, 22);
    public static final CustomToolMaterial ICE_DRAGONBONE_TOOL_MATERIAL = new CustomToolMaterial("IceDragonbone", 3, 2000, 5.5F, 10F, 22);
    public static final CustomToolMaterial LIGHTNING_DRAGONBONE_TOOL_MATERIAL = new CustomToolMaterial("LightningDragonbone", 3, 2000, 5.5F, 10F, 22);
    ...
    public static final CustomToolMaterial GHOST_SWORD_TOOL_MATERIAL = new CustomToolMaterial("GhostSword", 2, 3000, 5, 10.0F, 25);
    ...
    public static final Item SILVER_HELMET = register("armor_silver_metal_helmet", new ItemSilverArmor(SILVER_ARMOR_MATERIAL, ArmorItem.Type.HELMET));
    public static final Item SILVER_CHESTPLATE = register("armor_silver_metal_chestplate", new ItemSilverArmor(SILVER_ARMOR_MATERIAL, ArmorItem.Type.CHESTPLATE));
    public static final Item SILVER_LEGGINGS = register("armor_silver_metal_leggings", new ItemSilverArmor(SILVER_ARMOR_MATERIAL, ArmorItem.Type.LEGGINGS));
    public static final Item SILVER_BOOTS = register("armor_silver_metal_boots", new ItemSilverArmor(SILVER_ARMOR_MATERIAL, ArmorItem.Type.BOOTS));
    ...
    public static final Item COPPER_HELMET = register("armor_copper_metal_helmet", new ItemCopperArmor(COPPER_ARMOR_MATERIAL, ArmorItem.Type.HELMET));
    public static final Item COPPER_CHESTPLATE = register("armor_copper_metal_chestplate", new ItemCopperArmor(COPPER_ARMOR_MATERIAL, ArmorItem.Type.CHESTPLATE));
    public static final Item COPPER_LEGGINGS = register("armor_copper_metal_leggings", new ItemCopperArmor(COPPER_ARMOR_MATERIAL, ArmorItem.Type.LEGGINGS));
    public static final Item COPPER_BOOTS = register("armor_copper_metal_boots", new ItemCopperArmor(COPPER_ARMOR_MATERIAL, ArmorItem.Type.BOOTS));
    ...
    public static final Item DRAGONEGG_RED = register("dragonegg_red", new ItemDragonEgg(EnumDragonEgg.RED));
    public static final Item DRAGONEGG_GREEN = register("dragonegg_green", new ItemDragonEgg(EnumDragonEgg.GREEN));
    public static final Item DRAGONEGG_BRONZE = register("dragonegg_bronze", new ItemDragonEgg(EnumDragonEgg.BRONZE));
    public static final Item DRAGONEGG_GRAY = register("dragonegg_gray", new ItemDragonEgg(EnumDragonEgg.GRAY));
    public static final Item DRAGONEGG_BLUE = register("dragonegg_blue", new ItemDragonEgg(EnumDragonEgg.BLUE));
    public static final Item DRAGONEGG_WHITE = register("dragonegg_white", new ItemDragonEgg(EnumDragonEgg.WHITE));
    public static final Item DRAGONEGG_SAPPHIRE = register("dragonegg_sapphire", new ItemDragonEgg(EnumDragonEgg.SAPPHIRE));
    public static final Item DRAGONEGG_SILVER = register("dragonegg_silver", new ItemDragonEgg(EnumDragonEgg.SILVER));
    public static final Item DRAGONEGG_ELECTRIC = register("dragonegg_electric", new ItemDragonEgg(EnumDragonEgg.ELECTRIC));
    public static final Item DRAGONEGG_AMYTHEST = register("dragonegg_amythest", new ItemDragonEgg(EnumDragonEgg.AMYTHEST));
    public static final Item DRAGONEGG_COPPER = register("dragonegg_copper", new ItemDragonEgg(EnumDragonEgg.COPPER));
    public static final Item DRAGONEGG_BLACK = register("dragonegg_black", new ItemDragonEgg(EnumDragonEgg.BLACK));
    public static final Item DRAGONSCALES_RED = register("dragonscales_red", new ItemDragonScales(EnumDragonEgg.RED));
    public static final Item DRAGONSCALES_GREEN = register("dragonscales_green", new ItemDragonScales(EnumDragonEgg.GREEN));
    public static final Item DRAGONSCALES_BRONZE = register("dragonscales_bronze", new ItemDragonScales(EnumDragonEgg.BRONZE));
    public static final Item DRAGONSCALES_GRAY = register("dragonscales_gray", new ItemDragonScales(EnumDragonEgg.GRAY));
    public static final Item DRAGONSCALES_BLUE = register("dragonscales_blue", new ItemDragonScales(EnumDragonEgg.BLUE));
    public static final Item DRAGONSCALES_WHITE = register("dragonscales_white", new ItemDragonScales(EnumDragonEgg.WHITE));
    public static final Item DRAGONSCALES_SAPPHIRE = register("dragonscales_sapphire", new ItemDragonScales(EnumDragonEgg.SAPPHIRE));
    public static final Item DRAGONSCALES_SILVER = register("dragonscales_silver", new ItemDragonScales(EnumDragonEgg.SILVER));
    public static final Item DRAGONSCALES_ELECTRIC = register("dragonscales_electric", new ItemDragonScales(EnumDragonEgg.ELECTRIC));
    public static final Item DRAGONSCALES_AMYTHEST = register("dragonscales_amythest", new ItemDragonScales(EnumDragonEgg.AMYTHEST));
    public static final Item DRAGONSCALES_COPPER = register("dragonscales_copper", new ItemDragonScales(EnumDragonEgg.COPPER));
    public static final Item DRAGONSCALES_BLACK = register("dragonscales_black", new ItemDragonScales(EnumDragonEgg.BLACK));
    public static final Item DRAGON_BONE = register("dragonbone", new ItemDragonBone());
    public static final Item WITHERBONE = register("witherbone", new ItemGeneric());
    public static final Item FISHING_SPEAR = register("fishing_spear", new ItemFishingSpear());
    ...
    public static final Item DRAGON_STAFF = register("dragon_stick", new ItemDragonStaff());
    ...
    public static final Item DEATHWORM_YELLOW_HELMET = register("deathworm_yellow_helmet", new ItemDeathwormArmor(DEATHWORM_0_ARMOR_MATERIAL, ArmorItem.Type.HELMET));
    public static final Item DEATHWORM_YELLOW_CHESTPLATE = register("deathworm_yellow_chestplate", new ItemDeathwormArmor(DEATHWORM_0_ARMOR_MATERIAL, ArmorItem.Type.CHESTPLATE));
    public static final Item DEATHWORM_YELLOW_LEGGINGS = register("deathworm_yellow_leggings", new ItemDeathwormArmor(DEATHWORM_0_ARMOR_MATERIAL, ArmorItem.Type.LEGGINGS));
    public static final Item DEATHWORM_YELLOW_BOOTS = register("deathworm_yellow_boots", new ItemDeathwormArmor(DEATHWORM_0_ARMOR_MATERIAL, ArmorItem.Type.BOOTS));
    public static final Item DEATHWORM_WHITE_HELMET = register("deathworm_white_helmet", new ItemDeathwormArmor(DEATHWORM_1_ARMOR_MATERIAL, ArmorItem.Type.HELMET));
    public static final Item DEATHWORM_WHITE_CHESTPLATE = register("deathworm_white_chestplate", new ItemDeathwormArmor(DEATHWORM_1_ARMOR_MATERIAL, ArmorItem.Type.CHESTPLATE));
    public static final Item DEATHWORM_WHITE_LEGGINGS = register("deathworm_white_leggings", new ItemDeathwormArmor(DEATHWORM_1_ARMOR_MATERIAL, ArmorItem.Type.LEGGINGS));
    public static final Item DEATHWORM_WHITE_BOOTS = register("deathworm_white_boots", new ItemDeathwormArmor(DEATHWORM_1_ARMOR_MATERIAL, ArmorItem.Type.BOOTS));
    public static final Item DEATHWORM_RED_HELMET = register("deathworm_red_helmet", new ItemDeathwormArmor(DEATHWORM_2_ARMOR_MATERIAL, ArmorItem.Type.HELMET));
    public static final Item DEATHWORM_RED_CHESTPLATE = register("deathworm_red_chestplate", new ItemDeathwormArmor(DEATHWORM_2_ARMOR_MATERIAL, ArmorItem.Type.CHESTPLATE));
    public static final Item DEATHWORM_RED_LEGGINGS = register("deathworm_red_leggings", new ItemDeathwormArmor(DEATHWORM_2_ARMOR_MATERIAL, ArmorItem.Type.LEGGINGS));
    public static final Item DEATHWORM_RED_BOOTS = register("deathworm_red_boots", new ItemDeathwormArmor(DEATHWORM_2_ARMOR_MATERIAL, ArmorItem.Type.BOOTS));
    ...
    public static final BannerPatternItem PATTERN_FIRE = register("banner_pattern_fire", new BannerPatternItem(BannerPatternTagGenerator.FIRE_BANNER_PATTERN, unstackable()));
    public static final BannerPatternItem PATTERN_ICE = register("banner_pattern_ice", new BannerPatternItem(BannerPatternTagGenerator.ICE_BANNER_PATTERN, unstackable()));
    public static final BannerPatternItem PATTERN_LIGHTNING = register("banner_pattern_lightning", new BannerPatternItem(BannerPatternTagGenerator.LIGHTNING_BANNER_PATTERN, unstackable()));
    public static final BannerPatternItem PATTERN_FIRE_HEAD = register("banner_pattern_fire_head", new BannerPatternItem(BannerPatternTagGenerator.FIRE_HEAD_BANNER_PATTERN, unstackable()));
    public static final BannerPatternItem PATTERN_ICE_HEAD = register("banner_pattern_ice_head", new BannerPatternItem(BannerPatternTagGenerator.ICE_HEAD_BANNER_PATTERN, unstackable()));
    public static final BannerPatternItem PATTERN_LIGHTNING_HEAD = register("banner_pattern_lightning_head", new BannerPatternItem(BannerPatternTagGenerator.LIGHTNING_HEAD_BANNER_PATTERN, unstackable()));
    public static final BannerPatternItem PATTERN_AMPHITHERE = register("banner_pattern_amphithere", new BannerPatternItem(BannerPatternTagGenerator.AMPHITHERE_BANNER_PATTERN, unstackable()));
    public static final BannerPatternItem PATTERN_BIRD = register("banner_pattern_bird", new BannerPatternItem(BannerPatternTagGenerator.BIRD_BANNER_PATTERN, unstackable()));
    public static final BannerPatternItem PATTERN_EYE = register("banner_pattern_eye", new BannerPatternItem(BannerPatternTagGenerator.EYE_BANNER_PATTERN, unstackable()));
    public static final BannerPatternItem PATTERN_FAE = register("banner_pattern_fae", new BannerPatternItem(BannerPatternTagGenerator.FAE_BANNER_PATTERN, unstackable()));
    public static final BannerPatternItem PATTERN_FEATHER = register("banner_pattern_feather", new BannerPatternItem(BannerPatternTagGenerator.FEATHER_BANNER_PATTERN, unstackable()));
    public static final BannerPatternItem PATTERN_GORGON = register("banner_pattern_gorgon", new BannerPatternItem(BannerPatternTagGenerator.GORGON_BANNER_PATTERN, unstackable()));
    public static final BannerPatternItem PATTERN_HIPPOCAMPUS = register("banner_pattern_hippocampus", new BannerPatternItem(BannerPatternTagGenerator.HIPPOCAMPUS_BANNER_PATTERN, unstackable()));
    public static final BannerPatternItem PATTERN_HIPPOGRYPH_HEAD = register("banner_pattern_hippogryph_head", new BannerPatternItem(BannerPatternTagGenerator.HIPPOGRYPH_HEAD_BANNER_PATTERN, unstackable()));
    public static final BannerPatternItem PATTERN_MERMAID = register("banner_pattern_mermaid", new BannerPatternItem(BannerPatternTagGenerator.MERMAID_BANNER_PATTERN, unstackable()));
    public static final BannerPatternItem PATTERN_SEA_SERPENT = register("banner_pattern_sea_serpent", new BannerPatternItem(BannerPatternTagGenerator.SEA_SERPENT_BANNER_PATTERN, unstackable()));
    public static final BannerPatternItem PATTERN_TROLL = register("banner_pattern_troll", new BannerPatternItem(BannerPatternTagGenerator.TROLL_BANNER_PATTERN, unstackable()));
    public static final BannerPatternItem PATTERN_WEEZER = register("banner_pattern_weezer", new BannerPatternItem(BannerPatternTagGenerator.WEEZER_BANNER_PATTERN, unstackable()));
    public static final BannerPatternItem PATTERN_DREAD = register("banner_pattern_dread", new BannerPatternItem(BannerPatternTagGenerator.DREAD_BANNER_PATTERN, unstackable()));
    ...
    public static void registerItems() {
        //spawn Eggs
        register("spawn_egg_fire_dragon",  new SpawnEggItem(IafEntityRegistry.FIRE_DRAGON, 0X340000, 0XA52929, new Item.Settings()/*.tab(IceAndFire.TAB_ITEMS)*/));
        register("spawn_egg_ice_dragon",  new SpawnEggItem(IafEntityRegistry.ICE_DRAGON, 0XB5DDFB, 0X7EBAF0, new Item.Settings()/*.tab(IceAndFire.TAB_ITEMS)*/));
        register("spawn_egg_lightning_dragon",  new SpawnEggItem(IafEntityRegistry.LIGHTNING_DRAGON, 0X422367, 0X725691, new Item.Settings()/*.tab(IceAndFire.TAB_ITEMS)*/));
        register("spawn_egg_hippogryph",  new SpawnEggItem(IafEntityRegistry.HIPPOGRYPH, 0XD8D8D8, 0XD1B55D, new Item.Settings()/*.tab(IceAndFire.TAB_ITEMS)*/));
        register("spawn_egg_gorgon",  new SpawnEggItem(IafEntityRegistry.GORGON, 0XD0D99F, 0X684530, new Item.Settings()/*.tab(IceAndFire.TAB_ITEMS)*/));
        register("spawn_egg_pixie",  new SpawnEggItem(IafEntityRegistry.PIXIE, 0XFF7F89, 0XE2CCE2, new Item.Settings()/*.tab(IceAndFire.TAB_ITEMS)*/));
        register("spawn_egg_cyclops",  new SpawnEggItem(IafEntityRegistry.CYCLOPS, 0XB0826E, 0X3A1F0F, new Item.Settings()/*.tab(IceAndFire.TAB_ITEMS)*/));
        register("spawn_egg_siren",  new SpawnEggItem(IafEntityRegistry.SIREN, 0X8EE6CA, 0XF2DFC8, new Item.Settings()/*.tab(IceAndFire.TAB_ITEMS)*/));
        register("spawn_egg_hippocampus",  new SpawnEggItem(IafEntityRegistry.HIPPOCAMPUS, 0X4491C7, 0X4FC56B, new Item.Settings()/*.tab(IceAndFire.TAB_ITEMS)*/));
        register("spawn_egg_death_worm", new SpawnEggItem(IafEntityRegistry.DEATH_WORM, 0XD1CDA3, 0X423A3A, new Item.Settings()/*.tab(IceAndFire.TAB_ITEMS)*/));
        register("spawn_egg_cockatrice",  new SpawnEggItem(IafEntityRegistry.COCKATRICE, 0X8F5005, 0X4F5A23, new Item.Settings()/*.tab(IceAndFire.TAB_ITEMS)*/));
        register("spawn_egg_stymphalian_bird",  new SpawnEggItem(IafEntityRegistry.STYMPHALIAN_BIRD, 0X744F37, 0X9E6C4B, new Item.Settings()/*.tab(IceAndFire.TAB_ITEMS)*/));
        register("spawn_egg_troll",  new SpawnEggItem(IafEntityRegistry.TROLL, 0X3D413D, 0X58433A, new Item.Settings()/*.tab(IceAndFire.TAB_ITEMS)*/));
        register("spawn_egg_myrmex_worker",  new SpawnEggItem(IafEntityRegistry.MYRMEX_WORKER, 0XA16026, 0X594520, new Item.Settings()/*.tab(IceAndFire.TAB_ITEMS)*/));
        register("spawn_egg_myrmex_soldier",  new SpawnEggItem(IafEntityRegistry.MYRMEX_SOLDIER, 0XA16026, 0X7D622D, new Item.Settings()/*.tab(IceAndFire.TAB_ITEMS)*/));
        register("spawn_egg_myrmex_sentinel", new SpawnEggItem(IafEntityRegistry.MYRMEX_SENTINEL, 0XA16026, 0XA27F3A, new Item.Settings()/*.tab(IceAndFire.TAB_ITEMS)*/));
        register("spawn_egg_myrmex_royal",  new SpawnEggItem(IafEntityRegistry.MYRMEX_ROYAL, 0XA16026, 0XC79B48, new Item.Settings()/*.tab(IceAndFire.TAB_ITEMS)*/));
        register("spawn_egg_myrmex_queen",  new SpawnEggItem(IafEntityRegistry.MYRMEX_QUEEN, 0XA16026, 0XECB855, new Item.Settings()/*.tab(IceAndFire.TAB_ITEMS)*/));
        register("spawn_egg_amphithere",  new SpawnEggItem(IafEntityRegistry.AMPHITHERE, 0X597535, 0X00AA98, new Item.Settings()/*.tab(IceAndFire.TAB_ITEMS)*/));
        register("spawn_egg_sea_serpent", new SpawnEggItem(IafEntityRegistry.SEA_SERPENT, 0X008299, 0XC5E6E7, new Item.Settings()/*.tab(IceAndFire.TAB_ITEMS)*/));
        register("spawn_egg_dread_thrall",  new SpawnEggItem(IafEntityRegistry.DREAD_THRALL, 0XE0E6E6, 0X00FFFF, new Item.Settings()/*.tab(IceAndFire.TAB_ITEMS)*/));
        register("spawn_egg_dread_ghoul",  new SpawnEggItem(IafEntityRegistry.DREAD_GHOUL, 0XE0E6E6, 0X7B838A, new Item.Settings()/*.tab(IceAndFire.TAB_ITEMS)*/));
        register("spawn_egg_dread_beast",new SpawnEggItem(IafEntityRegistry.DREAD_BEAST, 0XE0E6E6, 0X38373C, new Item.Settings()/*.tab(IceAndFire.TAB_ITEMS)*/));
        register("spawn_egg_dread_scuttler",  new SpawnEggItem(IafEntityRegistry.DREAD_SCUTTLER, 0XE0E6E6, 0X4D5667, new Item.Settings()/*.tab(IceAndFire.TAB_ITEMS)*/));
        register("spawn_egg_lich", new SpawnEggItem(IafEntityRegistry.DREAD_LICH, 0XE0E6E6, 0X274860, new Item.Settings()/*.tab(IceAndFire.TAB_ITEMS)*/));
        register("spawn_egg_dread_knight", new SpawnEggItem(IafEntityRegistry.DREAD_KNIGHT, 0XE0E6E6, 0X4A6C6E, new Item.Settings()/*.tab(IceAndFire.TAB_ITEMS)*/));
        register("spawn_egg_dread_horse", new SpawnEggItem(IafEntityRegistry.DREAD_HORSE, 0XE0E6E6, 0XACACAC, new Item.Settings()/*.tab(IceAndFire.TAB_ITEMS)*/));
        register("spawn_egg_hydra", new SpawnEggItem(IafEntityRegistry.HYDRA, 0X8B8B78, 0X2E372B, new Item.Settings()/*.tab(IceAndFire.TAB_ITEMS)*/));
        register("spawn_egg_ghost", new SpawnEggItem(IafEntityRegistry.GHOST, 0XB9EDB8, 0X73B276, new Item.Settings()/*.tab(IceAndFire.TAB_ITEMS)*/));
    }
    ...
    public static <T extends Item> T register(String name,T item,boolean putInTab){
        if (putInTab) IafTabRegistry.TAB_ITEMS_LIST.add(item);
    ...
    public static void setRepairMaterials() {
        ...
        IafItemRegistry.DRAGONBONE_TOOL_MATERIAL.setRepairMaterial(Ingredient.ofItems(IafItemRegistry.DRAGON_BONE));
        IafItemRegistry.FIRE_DRAGONBONE_TOOL_MATERIAL.setRepairMaterial(Ingredient.ofItems(IafItemRegistry.DRAGON_BONE));
        IafItemRegistry.ICE_DRAGONBONE_TOOL_MATERIAL.setRepairMaterial(Ingredient.ofItems(IafItemRegistry.DRAGON_BONE));
        IafItemRegistry.LIGHTNING_DRAGONBONE_TOOL_MATERIAL.setRepairMaterial(Ingredient.ofItems(IafItemRegistry.DRAGON_BONE));
        for (EnumDragonArmor armor : EnumDragonArmor.values())
            armor.armorMaterial.setRepairMaterial(Ingredient.ofItems(EnumDragonArmor.getScaleItem(armor)));
        IafItemRegistry.DRAGONSTEEL_FIRE_ARMOR_MATERIAL.setRepairMaterial(Ingredient.ofItems(IafItemRegistry.DRAGONSTEEL_FIRE_INGOT));
        IafItemRegistry.DRAGONSTEEL_ICE_ARMOR_MATERIAL.setRepairMaterial(Ingredient.ofItems(IafItemRegistry.DRAGONSTEEL_ICE_INGOT));
        IafItemRegistry.DRAGONSTEEL_LIGHTNING_ARMOR_MATERIAL.setRepairMaterial(Ingredient.ofItems(IafItemRegistry.DRAGONSTEEL_LIGHTNING_INGOT));
        ...
        IafItemRegistry.DEATHWORM_0_ARMOR_MATERIAL.setRepairMaterial(Ingredient.ofItems(IafItemRegistry.DEATH_WORM_CHITIN_YELLOW));
        IafItemRegistry.DEATHWORM_1_ARMOR_MATERIAL.setRepairMaterial(Ingredient.ofItems(IafItemRegistry.DEATH_WORM_CHITIN_RED));
        IafItemRegistry.DEATHWORM_2_ARMOR_MATERIAL.setRepairMaterial(Ingredient.ofItems(IafItemRegistry.DEATH_WORM_CHITIN_WHITE));
        IafItemRegistry.TROLL_WEAPON_TOOL_MATERIAL.setRepairMaterial(Ingredient.ofItems(Items.STONE));
        IafItemRegistry.TROLL_MOUNTAIN_ARMOR_MATERIAL.setRepairMaterial(Ingredient.ofItems(EnumTroll.MOUNTAIN.leather));
        IafItemRegistry.TROLL_FOREST_ARMOR_MATERIAL.setRepairMaterial(Ingredient.ofItems(EnumTroll.FOREST.leather));
        IafItemRegistry.TROLL_FROST_ARMOR_MATERIAL.setRepairMaterial(Ingredient.ofItems(EnumTroll.FROST.leather));
        IafItemRegistry.HIPPOGRYPH_SWORD_TOOL_MATERIAL.setRepairMaterial(Ingredient.ofItems(IafItemRegistry.HIPPOGRYPH_TALON));
        IafItemRegistry.HIPPOCAMPUS_SWORD_TOOL_MATERIAL.setRepairMaterial(Ingredient.ofItems(IafItemRegistry.SHINY_SCALES));
        IafItemRegistry.AMPHITHERE_SWORD_TOOL_MATERIAL.setRepairMaterial(Ingredient.ofItems(IafItemRegistry.AMPHITHERE_FEATHER));
        IafItemRegistry.STYMHALIAN_SWORD_TOOL_MATERIAL.setRepairMaterial(Ingredient.ofItems(IafItemRegistry.STYMPHALIAN_BIRD_FEATHER));
        IafItemRegistry.MYRMEX_CHITIN_TOOL_MATERIAL.setRepairMaterial(Ingredient.ofItems(IafItemRegistry.MYRMEX_DESERT_CHITIN));
        IafItemRegistry.MYRMEX_DESERT_ARMOR_MATERIAL.setRepairMaterial(Ingredient.ofItems(IafItemRegistry.MYRMEX_DESERT_CHITIN));
        IafItemRegistry.MYRMEX_JUNGLE_ARMOR_MATERIAL.setRepairMaterial(Ingredient.ofItems(IafItemRegistry.MYRMEX_JUNGLE_CHITIN));
        IafItemRegistry.DREAD_SWORD_TOOL_MATERIAL.setRepairMaterial(Ingredient.ofItems(IafItemRegistry.DREAD_SHARD));
        IafItemRegistry.DREAD_KNIGHT_TOOL_MATERIAL.setRepairMaterial(Ingredient.ofItems(IafItemRegistry.DREAD_SHARD));
    ...
    public static void registerModelPredicates() {
        ModelPredicateProviderRegistry.register(IafItemRegistry.DRAGON_BOW, new Identifier("pulling"), (itemStack, clientWorld, livingEntity, seed) -> livingEntity != null && livingEntity.isUsingItem() && livingEntity.getActiveItem() == itemStack ? 1 : 0);
        ModelPredicateProviderRegistry.register(IafItemRegistry.DRAGON_BOW, new Identifier("pull"), (itemStack, clientWorld, livingEntity, seed) -> livingEntity == null ? 0 : livingEntity.getActiveItem() != itemStack ? 0 : (float) (itemStack.getMaxUseTime() - livingEntity.getItemUseTimeLeft()) / 20);

        ModelPredicateProviderRegistry.register(IafItemRegistry.DRAGON_HORN, new Identifier("iceorfire"), (stack, level, entity, p) -> ItemDragonHorn.getDragonType(stack) * 0.25F);
        ModelPredicateProviderRegistry.register(IafItemRegistry.SUMMONING_CRYSTAL_FIRE, new Identifier("has_dragon"), (stack, level, entity, p) -> ItemSummoningCrystal.hasDragon(stack) ? 1.0F : 0.0F);
        ModelPredicateProviderRegistry.register(IafItemRegistry.SUMMONING_CRYSTAL_ICE, new Identifier("has_dragon"), (stack, level, entity, p) -> ItemSummoningCrystal.hasDragon(stack) ? 1.0F : 0.0F);
        ModelPredicateProviderRegistry.register(IafItemRegistry.SUMMONING_CRYSTAL_LIGHTNING, new Identifier("has_dragon"), (stack, level, entity, p) -> ItemSummoningCrystal.hasDragon(stack) ? 1.0F : 0.0F);
        ModelPredicateProviderRegistry.register(IafItemRegistry.TIDE_TRIDENT, new Identifier("throwing"), (stack, level, entity, p) -> entity != null && entity.isUsingItem() && entity.getMainHandStack() == stack ? 1.0F : 0.0F);
    }
}
