...
public class IafBlockRegistry {
    ...
    public static final Block DRAGON_SCALE_RED = register("dragonscale_red", new BlockDragonScales(EnumDragonEgg.RED));
    public static final Block DRAGON_SCALE_GREEN = register("dragonscale_green", new BlockDragonScales(EnumDragonEgg.GREEN));
    public static final Block DRAGON_SCALE_BRONZE = register("dragonscale_bronze", new BlockDragonScales(EnumDragonEgg.BRONZE));
    public static final Block DRAGON_SCALE_GRAY = register("dragonscale_gray", new BlockDragonScales(EnumDragonEgg.GRAY));
    public static final Block DRAGON_SCALE_BLUE = register("dragonscale_blue", new BlockDragonScales(EnumDragonEgg.BLUE));
    public static final Block DRAGON_SCALE_WHITE = register("dragonscale_white", new BlockDragonScales(EnumDragonEgg.WHITE));
    public static final Block DRAGON_SCALE_SAPPHIRE = register("dragonscale_sapphire", new BlockDragonScales(EnumDragonEgg.SAPPHIRE));
    public static final Block DRAGON_SCALE_SILVER = register("dragonscale_silver", new BlockDragonScales(EnumDragonEgg.SILVER));
    public static final Block DRAGON_SCALE_ELECTRIC = register("dragonscale_electric", new BlockDragonScales(EnumDragonEgg.ELECTRIC));
    public static final Block DRAGON_SCALE_AMYTHEST = register("dragonscale_amythest", new BlockDragonScales(EnumDragonEgg.AMYTHEST));
    public static final Block DRAGON_SCALE_COPPER = register("dragonscale_copper", new BlockDragonScales(EnumDragonEgg.COPPER));
    public static final Block DRAGON_SCALE_BLACK = register("dragonscale_black", new BlockDragonScales(EnumDragonEgg.BLACK));

    public static final Block DRAGON_BONE_BLOCK = register("dragon_bone_block", new BlockDragonBone());
    public static final Block DRAGON_BONE_BLOCK_WALL = register("dragon_bone_wall", new BlockDragonBoneWall(AbstractBlock.Settings.copy(IafBlockRegistry.DRAGON_BONE_BLOCK)));
    ...
    public static <T extends Block> T register(String name, T block) {
        IafItemRegistry.register(name, new BlockItem(block, new FabricItemSettings()), false);
        IafTabRegistry.TAB_BLOCKS_LIST.add(block);
    ...
    public static <T extends TorchBlock> T registerWallBlock(String name, T block) {
        IafItemRegistry.register(name, new VerticallyAttachableBlockItem(block, ((IWallBlock) block).wallBlock(), new Item.Settings(), Direction.DOWN), false);
        IafTabRegistry.TAB_BLOCKS_LIST.add(block);
        return Registry.register(Registries.BLOCK, new Identifier(IceAndFire.MOD_ID, name), block);
    }
    ...
    public static void registerRenderLayers(){
        BlockRenderLayerMapImpl.INSTANCE.putBlock(IafBlockRegistry.GOLD_PILE, RenderLayer.getCutout());
        BlockRenderLayerMapImpl.INSTANCE.putBlock(IafBlockRegistry.SILVER_PILE, RenderLayer.getCutout());
        BlockRenderLayerMapImpl.INSTANCE.putBlock(IafBlockRegistry.LECTERN, RenderLayer.getCutout());
        BlockRenderLayerMapImpl.INSTANCE.putBlock(IafBlockRegistry.PODIUM_OAK, RenderLayer.getCutout());
        BlockRenderLayerMapImpl.INSTANCE.putBlock(IafBlockRegistry.PODIUM_BIRCH, RenderLayer.getCutout());
        BlockRenderLayerMapImpl.INSTANCE.putBlock(IafBlockRegistry.PODIUM_SPRUCE, RenderLayer.getCutout());
        BlockRenderLayerMapImpl.INSTANCE.putBlock(IafBlockRegistry.PODIUM_JUNGLE, RenderLayer.getCutout());
        BlockRenderLayerMapImpl.INSTANCE.putBlock(IafBlockRegistry.PODIUM_ACACIA, RenderLayer.getCutout());
        BlockRenderLayerMapImpl.INSTANCE.putBlock(IafBlockRegistry.PODIUM_DARK_OAK, RenderLayer.getCutout());
        BlockRenderLayerMapImpl.INSTANCE.putBlock(IafBlockRegistry.FIRE_LILY, RenderLayer.getCutout());
        BlockRenderLayerMapImpl.INSTANCE.putBlock(IafBlockRegistry.FROST_LILY, RenderLayer.getCutout());
        BlockRenderLayerMapImpl.INSTANCE.putBlock(IafBlockRegistry.LIGHTNING_LILY, RenderLayer.getCutout());
        BlockRenderLayerMapImpl.INSTANCE.putBlock(IafBlockRegistry.DRAGON_ICE_SPIKES, RenderLayer.getCutout());
        BlockRenderLayerMapImpl.INSTANCE.putBlock(IafBlockRegistry.MYRMEX_DESERT_RESIN_BLOCK, RenderLayer.getTranslucent());
        BlockRenderLayerMapImpl.INSTANCE.putBlock(IafBlockRegistry.MYRMEX_DESERT_RESIN_GLASS, RenderLayer.getTranslucent());
        BlockRenderLayerMapImpl.INSTANCE.putBlock(IafBlockRegistry.MYRMEX_JUNGLE_RESIN_BLOCK, RenderLayer.getTranslucent());
        BlockRenderLayerMapImpl.INSTANCE.putBlock(IafBlockRegistry.MYRMEX_JUNGLE_RESIN_GLASS, RenderLayer.getTranslucent());
        BlockRenderLayerMapImpl.INSTANCE.putBlock(IafBlockRegistry.MYRMEX_DESERT_BIOLIGHT, RenderLayer.getCutout());
        BlockRenderLayerMapImpl.INSTANCE.putBlock(IafBlockRegistry.MYRMEX_JUNGLE_BIOLIGHT, RenderLayer.getCutout());
        BlockRenderLayerMapImpl.INSTANCE.putBlock(IafBlockRegistry.DREAD_STONE_FACE, RenderLayer.getCutout());
        BlockRenderLayerMapImpl.INSTANCE.putBlock(IafBlockRegistry.DREAD_TORCH, RenderLayer.getCutout());
        BlockRenderLayerMapImpl.INSTANCE.putBlock(IafBlockRegistry.BURNT_TORCH, RenderLayer.getCutout());
        BlockRenderLayerMapImpl.INSTANCE.putBlock(IafBlockRegistry.EGG_IN_ICE, RenderLayer.getTranslucent());
        BlockRenderLayerMapImpl.INSTANCE.putBlock(IafBlockRegistry.JAR_EMPTY, RenderLayer.getCutout());
        BlockRenderLayerMapImpl.INSTANCE.putBlock(IafBlockRegistry.JAR_PIXIE_0, RenderLayer.getCutout());
        BlockRenderLayerMapImpl.INSTANCE.putBlock(IafBlockRegistry.JAR_PIXIE_1, RenderLayer.getCutout());
        BlockRenderLayerMapImpl.INSTANCE.putBlock(IafBlockRegistry.JAR_PIXIE_2, RenderLayer.getCutout());
        BlockRenderLayerMapImpl.INSTANCE.putBlock(IafBlockRegistry.JAR_PIXIE_3, RenderLayer.getCutout());
        BlockRenderLayerMapImpl.INSTANCE.putBlock(IafBlockRegistry.JAR_PIXIE_4, RenderLayer.getCutout());
        BlockRenderLayerMapImpl.INSTANCE.putBlock(IafBlockRegistry.PIXIE_HOUSE_MUSHROOM_BROWN, RenderLayer.getCutout());
        BlockRenderLayerMapImpl.INSTANCE.putBlock(IafBlockRegistry.PIXIE_HOUSE_MUSHROOM_RED, RenderLayer.getCutout());
        BlockRenderLayerMapImpl.INSTANCE.putBlock(IafBlockRegistry.PIXIE_HOUSE_OAK, RenderLayer.getCutout());
        BlockRenderLayerMapImpl.INSTANCE.putBlock(IafBlockRegistry.PIXIE_HOUSE_BIRCH, RenderLayer.getCutout());
        BlockRenderLayerMapImpl.INSTANCE.putBlock(IafBlockRegistry.PIXIE_HOUSE_SPRUCE, RenderLayer.getCutout());
        BlockRenderLayerMapImpl.INSTANCE.putBlock(IafBlockRegistry.PIXIE_HOUSE_DARK_OAK, RenderLayer.getCutout());
        BlockRenderLayerMapImpl.INSTANCE.putBlock(IafBlockRegistry.DREAD_SPAWNER, RenderLayer.getCutout());
        BlockRenderLayerMapImpl.INSTANCE.putBlock(IafBlockRegistry.DREAD_TORCH_WALL, RenderLayer.getCutout());
        BlockRenderLayerMapImpl.INSTANCE.putBlock(IafBlockRegistry.BURNT_TORCH_WALL, RenderLayer.getCutout());
    }
}
