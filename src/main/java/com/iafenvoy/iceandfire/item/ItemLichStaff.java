...
public class ItemLichStaff extends Item {
    ...
    public boolean canRepair(ItemStack toRepair, ItemStack repair) {
        return repair.getItem() == IafItems.DREAD_SHARD || super.canRepair(toRepair, repair);
    }
    ...
    public TypedActionResult<ItemStack> use(World worldIn, PlayerEntity playerIn, Hand hand) {
        ...
        if (!worldIn.isClient) {
            ...
            EntityDreadLichSkull charge = new EntityDreadLichSkull(IafEntities.DREAD_LICH_SKULL, worldIn, playerIn, 6);
