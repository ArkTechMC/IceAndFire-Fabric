...
public class SpawnProbabilityModifier implements BiomeModifier {
    ...
    private static final RegistryObject<Codec<? extends BiomeModifier>> SERIALIZER = new RegistryObject<>(new Identifier("citadel:mob_spawn_probability"), ForgeRegistries.Keys.BIOME_MODIFIER_SERIALIZERS, "citadel");
