...
public class IafItems {
    ...
    public static final CustomArmorMaterial DRAGONSTEEL_FIRE_ARMOR_MATERIAL = new DragonSteelArmorMaterial("dragonsteel_fire", (int) (0.02D * IafConfig.getInstance().armors.dragonsteel.baseDurabilityEquipment), new int[]{IafConfig.getInstance().armors.dragonsteel.baseArmor - 6, IafConfig.getInstance().armors.dragonsteel.baseArmor - 3, IafConfig.getInstance().armors.dragonsteel.baseArmor, IafConfig.getInstance().armors.dragonsteel.baseArmor - 5}, 30, SoundEvents.ITEM_ARMOR_EQUIP_DIAMOND, IafConfig.getInstance().armors.dragonsteel.baseArmorToughness);
    public static final CustomArmorMaterial DRAGONSTEEL_ICE_ARMOR_MATERIAL = new DragonSteelArmorMaterial("dragonsteel_ice", (int) (0.02D * IafConfig.getInstance().armors.dragonsteel.baseDurabilityEquipment), new int[]{IafConfig.getInstance().armors.dragonsteel.baseArmor - 6, IafConfig.getInstance().armors.dragonsteel.baseArmor - 3, IafConfig.getInstance().armors.dragonsteel.baseArmor, IafConfig.getInstance().armors.dragonsteel.baseArmor - 5}, 30, SoundEvents.ITEM_ARMOR_EQUIP_DIAMOND, IafConfig.getInstance().armors.dragonsteel.baseArmorToughness);
    public static final CustomArmorMaterial DRAGONSTEEL_LIGHTNING_ARMOR_MATERIAL = new DragonSteelArmorMaterial("dragonsteel_lightning", (int) (0.02D * IafConfig.getInstance().armors.dragonsteel.baseDurabilityEquipment), new int[]{IafConfig.getInstance().armors.dragonsteel.baseArmor - 6, IafConfig.getInstance().armors.dragonsteel.baseArmor - 3, IafConfig.getInstance().armors.dragonsteel.baseArmor, IafConfig.getInstance().armors.dragonsteel.baseArmor - 5}, 30, SoundEvents.ITEM_ARMOR_EQUIP_DIAMOND, IafConfig.getInstance().armors.dragonsteel.baseArmorToughness);
