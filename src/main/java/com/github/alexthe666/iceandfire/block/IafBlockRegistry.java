...
public class IafBlockRegistry {
    ...
    public static final RegistryObject<Block> SILVER_ORE = register("silver_ore", () -> new ExperienceDroppingBlock(AbstractBlock.Settings.create().mapColor(MapColor.STONE_GRAY).strength(3, 3).requiresTool()));
    public static final RegistryObject<Block> DEEPSLATE_SILVER_ORE = register("deepslate_silver_ore", () -> new ExperienceDroppingBlock(AbstractBlock.Settings.create().mapColor(MapColor.DEEPSLATE_GRAY).strength(3, 3).requiresTool()));
    public static final RegistryObject<Block> SILVER_BLOCK = register("silver_block", () -> BlockGeneric.builder(3.0F, 5.0F, BlockSoundGroup.METAL, MapColor.IRON_GRAY, null, null, false));
    public static final RegistryObject<Block> SAPPHIRE_ORE = register("sapphire_ore", () -> new ExperienceDroppingBlock(AbstractBlock.Settings.create().mapColor(MapColor.STONE_GRAY).strength(4, 3).requiresTool(), UniformIntProvider.create(3, 7)));
    public static final RegistryObject<Block> SAPPHIRE_BLOCK = register("sapphire_block", () -> BlockGeneric.builder(3.0F, 6.0F, BlockSoundGroup.METAL, MapColor.IRON_GRAY, null, null, false));
    public static final RegistryObject<Block> RAW_SILVER_BLOCK = register("raw_silver_block", () -> BlockGeneric.builder(3.0F, 5.0F, BlockSoundGroup.STONE, MapColor.IRON_GRAY, Instrument.BASEDRUM, null, false));
    public static final RegistryObject<Block> CHARRED_DIRT = register("chared_dirt", () -> BlockReturningState.builder(0.5F, 0.0F, BlockSoundGroup.GRAVEL, MapColor.DIRT_BROWN, null, null, false, Blocks.DIRT.getDefaultState()));
    public static final RegistryObject<Block> CHARRED_GRASS = register("chared_grass", () -> BlockReturningState.builder(0.6F, 0.0F, BlockSoundGroup.GRAVEL, MapColor.PALE_GREEN, null, null, false, Blocks.GRASS_BLOCK.getDefaultState()));
    public static final RegistryObject<Block> CHARRED_STONE = register("chared_stone", () -> BlockReturningState.builder(1.5F, 10.0F, BlockSoundGroup.STONE, MapColor.STONE_GRAY, Instrument.BASEDRUM, null, false, Blocks.STONE.getDefaultState()));
    public static final RegistryObject<Block> CHARRED_COBBLESTONE = register("chared_cobblestone", () -> BlockReturningState.builder(2F, 10.0F, BlockSoundGroup.STONE, MapColor.STONE_GRAY, Instrument.BASEDRUM, null, false, Blocks.COBBLESTONE.getDefaultState()));
    public static final RegistryObject<Block> CHARRED_GRAVEL = register("chared_gravel", () -> new BlockFallingReturningState(0.6F, 0F, BlockSoundGroup.GRAVEL, MapColor.DIRT_BROWN, Blocks.GRAVEL.getDefaultState()));
    ...
    public static final RegistryObject<Block> ASH = register("ash", () -> BlockFallingGeneric.builder(0.5F, 0F, BlockSoundGroup.SAND, MapColor.PALE_YELLOW, Instrument.SNARE));
    public static final RegistryObject<Block> FROZEN_DIRT = register("frozen_dirt", () -> BlockReturningState.builder(0.5F, 0.0F, BlockSoundGroup.GLASS, true, MapColor.DIRT_BROWN, null, null, false, Blocks.DIRT.getDefaultState()));
    public static final RegistryObject<Block> FROZEN_GRASS = register("frozen_grass", () -> BlockReturningState.builder(0.6F, 0.0F, BlockSoundGroup.GLASS, true, MapColor.PALE_GREEN, null, null, false, Blocks.GRASS_BLOCK.getDefaultState()));
    public static final RegistryObject<Block> FROZEN_STONE = register("frozen_stone", () -> BlockReturningState.builder(1.5F, 1.0F, BlockSoundGroup.GLASS, true, MapColor.STONE_GRAY, Instrument.BASEDRUM, null, false, Blocks.STONE.getDefaultState()));
    public static final RegistryObject<Block> FROZEN_COBBLESTONE = register("frozen_cobblestone", () -> BlockReturningState.builder(2F, 2.0F, BlockSoundGroup.GLASS, true, MapColor.STONE_GRAY, Instrument.BASEDRUM, null, false, Blocks.COBBLESTONE.getDefaultState()));
    public static final RegistryObject<Block> FROZEN_GRAVEL = register("frozen_gravel", () -> new BlockFallingReturningState(0.6F, 0F, BlockSoundGroup.GLASS, true, MapColor.DIRT_BROWN, Blocks.GRAVEL.getDefaultState()));
    ...
    public static final RegistryObject<Block> FROZEN_SPLINTERS = register("frozen_splinters", () -> BlockGeneric.builder(2.0F, 1.0F, BlockSoundGroup.GLASS, true, MapColor.OAK_TAN, Instrument.BASS, null, true));
    public static final RegistryObject<Block> DRAGON_ICE = register("dragon_ice", () -> BlockGeneric.builder(0.5F, 0F, BlockSoundGroup.GLASS, true, MapColor.PALE_PURPLE, null, null, false));
    public static final RegistryObject<Block> DRAGON_ICE_SPIKES = register("dragon_ice_spikes", BlockIceSpikes::new);
    public static final RegistryObject<Block> CRACKLED_DIRT = register("crackled_dirt", () -> BlockReturningState.builder(0.5F, 0.0F, BlockSoundGroup.GRAVEL, MapColor.DIRT_BROWN, null, null, false, Blocks.DIRT.getDefaultState()));
    public static final RegistryObject<Block> CRACKLED_GRASS = register("crackled_grass", () -> BlockReturningState.builder(0.6F, 0.0F, BlockSoundGroup.GRAVEL, MapColor.PALE_GREEN, null, null, false, Blocks.GRASS_BLOCK.getDefaultState()));
    public static final RegistryObject<Block> CRACKLED_STONE = register("crackled_stone", () -> BlockReturningState.builder(1.5F, 1.0F, BlockSoundGroup.STONE, MapColor.STONE_GRAY, Instrument.BASEDRUM, null, false, Blocks.STONE.getDefaultState()));
    public static final RegistryObject<Block> CRACKLED_COBBLESTONE = register("crackled_cobblestone", () -> BlockReturningState.builder(2F, 2F, BlockSoundGroup.STONE, MapColor.STONE_GRAY, Instrument.BASEDRUM, null, false, Blocks.COBBLESTONE.getDefaultState()));
    public static final RegistryObject<Block> CRACKLED_GRAVEL = register("crackled_gravel", () -> new BlockFallingReturningState(0.6F, 0F, BlockSoundGroup.GRAVEL, MapColor.DIRT_BROWN, Blocks.GRAVEL.getDefaultState()));
    ...
    public static final RegistryObject<Block> NEST = register("nest", () -> BlockGeneric.builder(0.5F, 0F, BlockSoundGroup.GRAVEL, false, MapColor.DARK_GREEN, null, PistonBehavior.DESTROY, false));
    ...
    public static final RegistryObject<Block> DRAGON_BONE_BLOCK_WALL = register("dragon_bone_wall", () -> new BlockDragonBoneWall(AbstractBlock.Settings.copy(IafBlockRegistry.DRAGON_BONE_BLOCK.get())));
    ...
    public static final RegistryObject<Block> DRAGONSTEEL_FIRE_BLOCK = register("dragonsteel_fire_block", () -> BlockGeneric.builder(10.0F, 1000.0F, BlockSoundGroup.METAL, MapColor.IRON_GRAY, null, null, false));
    public static final RegistryObject<Block> DRAGONSTEEL_ICE_BLOCK = register("dragonsteel_ice_block", () -> BlockGeneric.builder(10.0F, 1000.0F, BlockSoundGroup.METAL, MapColor.IRON_GRAY, null, null, false));
    ...
    public static final RegistryObject<Block> DREAD_STONE_BRICKS_STAIRS = register("dread_stone_stairs", () -> new StairsBlock(DREAD_STONE_BRICKS.get().getDefaultState(), AbstractBlock.Settings.create().strength(20F)));
    ...
    public static final RegistryObject<BlockDreadBase> DREAD_STONE_TILE = register("dread_stone_tile", () -> BlockDreadBase.builder(-1.0F, 100000.0F, BlockSoundGroup.STONE, MapColor.STONE_GRAY, null, false));
    ...
    public static <T extends Block> RegistryObject<T> register(String name, Supplier<T> block) {
        ...
        IafItemRegistry.registerItem(name, () -> new BlockItem(ret.get(), new Item.Settings()), false);
