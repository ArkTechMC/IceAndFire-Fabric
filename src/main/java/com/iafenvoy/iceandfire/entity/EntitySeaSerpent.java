...
public class EntitySeaSerpent extends AnimalEntity implements IAnimatedEntity, IMultipartEntity, IVillagerFear, IAnimalFear, IHasCustomizableAttributes {
    ...
    public static DefaultAttributeContainer.Builder bakeAttributes() {
        return MobEntity.createMobAttributes()
                //HEALTH
                .add(EntityAttributes.GENERIC_MAX_HEALTH, IafCommonConfig.INSTANCE.seaSerpent.baseHealth)
                //SPEED
    ...
    public void setConfigurableAttributes() {
        this.getAttributeInstance(EntityAttributes.GENERIC_MAX_HEALTH).setBaseValue(IafCommonConfig.INSTANCE.seaSerpent.baseHealth);
    ...
    private void updateAttributes() {
        ...
        this.getAttributeInstance(EntityAttributes.GENERIC_ATTACK_DAMAGE).setBaseValue(Math.max(4, IafCommonConfig.INSTANCE.seaSerpent.attackDamage * this.getSeaSerpentScale() * this.getAncientModifier()));
        this.getAttributeInstance(EntityAttributes.GENERIC_MAX_HEALTH).setBaseValue(Math.max(10, IafCommonConfig.INSTANCE.seaSerpent.baseHealth * this.getSeaSerpentScale() * this.getAncientModifier()));
        this.getAttributeInstance(EntityAttributes.GENERIC_FOLLOW_RANGE).setBaseValue(Math.min(2048, IafCommonConfig.INSTANCE.dragon.behaviour.targetSearchLength));
    ...
    public void breakBlock() {
        if (IafCommonConfig.INSTANCE.seaSerpent.griefing)
