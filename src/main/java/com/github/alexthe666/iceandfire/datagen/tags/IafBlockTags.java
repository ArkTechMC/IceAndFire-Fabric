...
public class IafBlockTags extends BlockTagProvider {
    ...
    protected void configure(RegistryWrapper.WrapperLookup pProvider) {
        ...
        tag(TagKey.of(RegistryKeys.BLOCK, new Identifier("forge", "ores/silver"))).add(IafBlockRegistry.SILVER_ORE.get());
        tag(TagKey.of(RegistryKeys.BLOCK, new Identifier("forge", "ores/silver"))).add(IafBlockRegistry.DEEPSLATE_SILVER_ORE.get());
    }
