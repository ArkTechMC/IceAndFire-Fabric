...
public class ModelCyclops extends ModelDragonBase<EntityCyclops> {
    ...
    public final AdvancedModelBox Horn;
    public final AdvancedModelBox rightear;
    public final AdvancedModelBox Leftear;
    public final AdvancedModelBox Jaw;
    public final AdvancedModelBox topTeethL;
    public final AdvancedModelBox topTeethR;
    public final AdvancedModelBox Eye_1;
    public final AdvancedModelBox Horn2;
    public final AdvancedModelBox bottomTeethR;
    public final AdvancedModelBox bottomTeethL;
    public final AdvancedModelBox rightarm2;
    public final AdvancedModelBox leftarm2;
    public final AdvancedModelBox LoinBack;
    ...
    public ModelCyclops() {
        ...
        this.setRotateAngle(this.rightear, -0.06981317007977318F, -0.5235987755982988F, 0.0F);
        ...
        this.setRotateAngle(this.Belly, 0.045553093477052F, 0.0F, 0.0F);
        ...
        this.setRotateAngle(this.leftleg2, 0.0F, 0.0F, 0.017453292519943295F);
        ...
        this.setRotateAngle(this.LoinBack, 0.0F, -3.141592653589793F, 0.0F);
        ...
        this.setRotateAngle(this.Leftear, -0.06981317007977318F, 0.5235987755982988F, 0.0F);
        ...
        this.setRotateAngle(this.leftarm, 0.045553093477052F, 0.0F, -0.17453292519943295F);
        this.Horn = new AdvancedModelBox(this, 29, 0);
        this.Horn.setPos(0.0F, -5.7F, -1.2F);
        this.Horn.addBox(-1.5F, -5.6F, -2.8F, 3, 3, 3, 0.0F);
        this.setRotateAngle(this.Horn, 0.4553564018453205F, 0.0F, 0.0F);
        ...
        this.setRotateAngle(this.Eye, 0.091106186954104F, 0.0F, 0.0F);
        ...
        this.setRotateAngle(this.rightarm2, -0.08726646259971647F, 0.0F, 0.0F);
        ...
        this.setRotateAngle(this.leftleg, 0.0F, 0.0F, -0.017453292519943295F);
        ...
        this.setRotateAngle(this.rightleg2, 0.0F, 0.0F, -0.017453292519943295F);
        ...
        this.setRotateAngle(this.leftarm2, -0.08726646259971647F, 0.0F, 0.0F);
        ...
        this.setRotateAngle(this.rightleg, 0.0F, 0.0F, 0.017453292519943295F);
    ...
    public Iterable<AdvancedModelBox> getAllParts() {
        return ImmutableList.of(this.body, this.UpperBody, this.Loin, this.rightleg, this.leftleg, this.Head, this.rightarm, this.leftarm, this.Belly, this.Chest, this.Eye, this.Horn, this.rightear,
                this.Leftear, this.Jaw, this.topTeethL, this.topTeethR, this.Eye_1, this.Horn2, this.bottomTeethR, this.bottomTeethL, this.rightarm2, this.leftarm2, this.LoinBack, this.rightleg2, this.leftleg2);
    }
    ...
    public void animate(IAnimatedEntity entity, float f, float f1, float f2, float f3, float f4) {
        ...
        if (this.animator.setAnimation(EntityCyclops.ANIMATION_STOMP)) {
            ...
            this.rotate(this.animator, this.rightleg2, 46, 0, 0);
            this.animator.move(this.rightleg2, 0, 1.1F, -1.7F);
            this.rotate(this.animator, this.leftleg, 10, 0, 0);
            this.rotate(this.animator, this.leftleg2, 10, 0, 0);
            this.animator.move(this.leftleg2, 0, 0, -0.3F);
            this.rotate(this.animator, this.body, -15, 0, 0);
            this.rotate(this.animator, this.UpperBody, 7, 0, 0);
            this.animator.endKeyframe();
            this.animator.setStaticKeyframe(5);
            this.animator.startKeyframe(5);
            this.rotate(this.animator, this.body, 5, 0, 0);
            this.rotate(this.animator, this.UpperBody, 7.5F, 0, 0);
            this.rotate(this.animator, this.rightleg, -46, 0, 0);
            this.rotate(this.animator, this.rightleg2, 36, 0, 0);
            this.rotate(this.animator, this.leftleg, 7, 0, 0);
            this.rotate(this.animator, this.leftleg2, 2, 0, 0);
            this.animator.move(this.rightleg2, 0, 1.1F, -0.9F);
        ...
        if (this.animator.setAnimation(EntityCyclops.ANIMATION_KICK)) {
            ...
            this.rotate(this.animator, this.body, 3, 0, 0);
            this.rotate(this.animator, this.leftleg, 13, 0, 0);
            this.rotate(this.animator, this.leftleg2, 18, 0, 0);
            this.animator.move(this.leftleg2, 0, 1, -0.9F);
            this.rotate(this.animator, this.rightleg, -26, 0, 0);
            this.rotate(this.animator, this.rightleg2, 23, 0, 0);
            this.animator.move(this.leftleg2, 0, 1.2F, -1.1F);
            this.animator.endKeyframe();
            this.animator.startKeyframe(5);
            this.rotate(this.animator, this.body, -2, 0, 0);
            this.rotate(this.animator, this.rightleg, -55, 0, 0);
            this.rotate(this.animator, this.rightleg2, 18, 0, 0);
            this.animator.move(this.leftleg2, 0, 2, -0.5F);
            this.rotate(this.animator, this.leftleg, 10, 0, 0);
            this.animator.endKeyframe();
        ...
        if (this.animator.setAnimation(EntityCyclops.ANIMATION_EATPLAYER)) {
            this.animator.startKeyframe(10);
            this.animator.move(this.body, 0, 7, 0);
            this.rotate(this.animator, this.body, 25, 0, 0);
            this.rotate(this.animator, this.leftleg, -7, 0, 0);
            this.rotate(this.animator, this.rightleg, -85, 0, 0);
            this.rotate(this.animator, this.rightleg2, 50, 0, 0);
            this.rotate(this.animator, this.leftleg2, 52, 0, 0);
            this.animator.move(this.leftleg2, 0, 1.1F, -2);
            this.animator.move(this.rightleg2, 0, 1, -2);
            this.rotate(this.animator, this.UpperBody, 40, 0, 0);
            this.animator.move(this.UpperBody, 0, 1.7F, 0);
            this.rotate(this.animator, this.rightarm, -80, 0, 0);
            this.rotate(this.animator, this.leftarm, -80, 0, 0);
            this.rotate(this.animator, this.rightarm2, 0, 0, -23);
            this.rotate(this.animator, this.leftarm2, 0, 0, 23);
            this.animator.endKeyframe();
            this.animator.startKeyframe(15);
            this.rotate(this.animator, this.rightarm, -40, -25, 40);
            this.rotate(this.animator, this.rightarm2, -120, 0, 0);
            this.rotate(this.animator, this.leftarm, -40, 25, -40);
            this.rotate(this.animator, this.leftarm2, -120, 0, 0);
            this.animator.move(this.rightarm2, 0, 1.2F, 1.4F);
            this.animator.move(this.leftarm2, 0, 1.2F, 1.4F);
            this.rotate(this.animator, this.Head, -25, 0, 0);
            this.animator.move(this.Head, 0, -0.5F, 0);
            ...
            this.animator.move(this.rightarm2, 0, 1.2F, 1.4F);
            this.animator.move(this.leftarm2, 0, 1.2F, 1.4F);
            this.rotate(this.animator, this.Head, -48, 0, 0);
            this.animator.move(this.Head, 0, -0.8F, 0);
            this.rotate(this.animator, this.Jaw, 57, 0, 0);
            this.animator.endKeyframe();
            this.animator.startKeyframe(5);
            this.rotate(this.animator, this.rightarm, -40, -25, 40);
            this.rotate(this.animator, this.rightarm2, -120, 0, 0);
        ...
        if (this.animator.setAnimation(EntityCyclops.ANIMATION_ROAR)) {
            this.animator.startKeyframe(5);
            this.rotate(this.animator, this.body, 15, 0, 0);
            this.rotate(this.animator, this.leftleg, -20, -15, -15);
            this.rotate(this.animator, this.leftleg2, 15, 0, 15);
            this.rotate(this.animator, this.rightleg, -20, 15, 15);
            this.rotate(this.animator, this.rightleg2, 15, 0, -15);
            ...
            this.rotate(this.animator, this.Head, -25, 0, 0);
            this.rotate(this.animator, this.rightarm, -25, 35, 25);
            this.rotate(this.animator, this.leftarm, -25, -35, -25);
            this.rotate(this.animator, this.rightarm2, -28, 0, 0);
            this.rotate(this.animator, this.leftarm2, -28, 0, 0);
            this.animator.move(this.Head, 0, 0, -0.5F);
            this.animator.endKeyframe();
            this.animator.startKeyframe(5);
            this.rotate(this.animator, this.body, 15, 0, 0);
            this.rotate(this.animator, this.leftleg, -20, -15, -15);
            ...
            this.rotate(this.animator, this.rightarm2, -28, 0, 0);
            this.rotate(this.animator, this.leftarm2, -28, 0, 0);
            this.rotate(this.animator, this.Head, -45, 20, 0);
