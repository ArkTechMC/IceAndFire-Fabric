...
public class ModelGorgon extends ModelDragonBase<EntityGorgon> {
    ...
    public final AdvancedModelBox Tail_4;
    public final AdvancedModelBox Tail_5;
    public final AdvancedModelBox Tail_6;
    public final AdvancedModelBox Tail_7;
    public final AdvancedModelBox Tail_8;
    public final AdvancedModelBox Tail_9;
    ...
    public ModelGorgon() {
        ...
        this.setRotateAngle(this.Tail_8, 0.045553093477052F, 0.0F, 0.0F);
        ...
        this.setRotateAngle(this.Tail_1, -0.022514747350726852F, 0.0F, 0.0F);
        ...
        this.setRotateAngle(this.Tail_5, 0.27314402793711257F, 0.0F, 0.0F);
        ...
        this.setRotateAngle(this.Tail_4, 0.4553564018453205F, 0.0F, 0.0F);
        ...
        this.setRotateAngle(this.Tail_2, 0.11292280260403312F, 0.0F, 0.0F);
        ...
        this.setRotateAngle(this.Body, 0.022514747350726852F, 0.0F, 0.0F);
        ...
        this.setRotateAngle(this.Tail_9, 0.045553093477052F, 0.0F, 0.0F);
        ...
        this.setRotateAngle(this.Tail_3, 0.7398450699203963F, 0.0F, 0.0F);
    ...
    public void animate(IAnimatedEntity entity, float f, float f1, float f2, float f3, float f4, float f5) {
        ...
        if (this.animator.setAnimation(EntityGorgon.ANIMATION_SCARE)) {
            ...
            this.rotate(this.animator, this.Left_Arm, 0, -12.5F, -70F);
            this.rotate(this.animator, this.Right_Arm, 0, 12.5F, 70F);
            this.animator.endKeyframe();
            this.animator.startKeyframe(5);
            this.rotate(this.animator, this.Head, 0, -20, 0);
            this.rotate(this.animator, this.Left_Arm, 0, -25, -140);
            this.rotate(this.animator, this.Right_Arm, 0, 25, 140);
            this.animator.endKeyframe();
            this.animator.startKeyframe(5);
            this.rotate(this.animator, this.Head, 0, 20, 0);
            this.rotate(this.animator, this.Left_Arm, 0, -25, -140);
        ...
        if (this.animator.setAnimation(EntityGorgon.ANIMATION_HIT)) {
            this.animator.startKeyframe(5);
            this.rotate(this.animator, this.Body, 10F, 0F, 0F);

            this.rotate(this.animator, this.Left_Arm, -120F, 0F, 0F);
            this.rotate(this.animator, this.Right_Arm, -120F, 0F, 0F);
            this.animator.endKeyframe();
    ...
    public void setAngles(EntityGorgon entity, float f, float f1, float f2, float f3, float f4) {
        ...
        this.progressRotation(this.Tail_2, deathProg, (float) Math.toRadians(18), (float) Math.toRadians(-54), 0);
        this.progressRotation(this.Body, deathProg, (float) Math.toRadians(-9), (float) Math.toRadians(36), 0);
        this.progressRotation(this.Right_Arm, deathProg, 0, 0, (float) Math.toRadians(20));
        this.progressRotation(this.Left_Arm, deathProg, 0, 0, (float) Math.toRadians(-20));
    ...
    public Iterable<AdvancedModelBox> getAllParts() {
        return ImmutableList.of(this.Tail_1, this.Tail_2, this.Body, this.Tail_3, this.Tail_4, this.Tail_5, this.Tail_6, this.Tail_7, this.Tail_8, this.Tail_9, this.Left_Arm,
                this.Head, this.Right_Arm, this.Neck, this.Head_Details, this.SnakeBaseR2, this.SnakeBaseR7, this.SnakeBaseR6, this.SnakeBaseR5, this.SnakeBaseR4,
                this.SnakeBaseR3, this.SnakeBaseR1, this.SnakeBaseL1, this.SnakeBaseL2, this.SnakeBaseL4, this.SnakeBaseL3, this.SnakeBaseL7, this.SnakeBaseL6,
                this.SnakeBaseL5, this.SnakeBodyR2, this.SnakeHeadR2, this.SnakeJawR2, this.SnakeFang1R2, this.SnakeFang2R2, this.SnakeBodyR7, this.SnakeHeadR7,
                this.SnakeJawR7, this.SnakeFang1R7, this.SnakeFang2R7, this.SnakeBodyR6, this.SnakeHeadR6, this.SnakeJawR6, this.SnakeFang1R6, this.SnakeFang2R6,
                this.SnakeBodyR5, this.SnakeHeadR5, this.SnakeJawR5, this.SnakeFang1R5, this.SnakeFang2R5, this.SnakeBodyR4, this.SnakeHeadR4, this.SnakeJawR4,
                this.SnakeFang1R4, this.SnakeFang2R4, this.SnakeBodyR3, this.SnakeHeadR3, this.SnakeJawR3, this.SnakeFang1R3, this.SnakeFang2R3, this.SnakeBodyR1,
                this.SnakeHeadR1, this.SnakeJawR1, this.SnakeFang1R1, this.SnakeFang2R1, this.SnakeBodyL1, this.SnakeHeadL1, this.SnakeJawL1, this.SnakeFang1L1,
                this.SnakeFang2L1, this.SnakeBodyL2, this.SnakeHeadL2, this.SnakeJawL2, this.SnakeFang1L2, this.SnakeFang2L2, this.SnakeBodyL4, this.SnakeHeadR4_1,
                this.SnakeJawR4_1, this.SnakeFang1R4_1, this.SnakeFang2R4_1, this.SnakeBodyL3, this.SnakeHeadL3, this.SnakeJawL3, this.SnakeFang1L3,
                this.SnakeFang2L3, this.SnakeBodyL7, this.SnakeHeadL7, this.SnakeJawL7, this.SnakeFang1L7, this.SnakeFang2L7, this.snakeBodyL6, this.SnakeHeadL6,
                this.SnakeJawL6, this.SnakeFang1L6, this.SnakeFang2L6, this.SnakeBodyL5, this.SnakeHeadL5, this.SnakeJawL5, this.SnakeFang1L5, this.SnakeFang2L5);
    }
