...
public class IafTrades {
    ...
    public static void addScribeTrades() {
        assert SCRIBE != null;
        final VillagerProfession scribe = SCRIBE.profession();
        ...
        TradeOfferHelper.registerVillagerOffers(scribe, 1,
        ...
        TradeOfferHelper.registerVillagerOffers(scribe, 2,
        ...
        TradeOfferHelper.registerVillagerOffers(scribe, 3,
        ...
        TradeOfferHelper.registerVillagerOffers(scribe, 4,
        ...
        TradeOfferHelper.registerVillagerOffers(scribe, 5,
