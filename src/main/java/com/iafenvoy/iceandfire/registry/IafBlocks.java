...
public final class IafBlocks {
    ...
    public static final BlockDreadBase DREAD_STONE = register("dread_stone", new BlockDreadBase(false));
    public static final BlockDreadBase DREAD_STONE_BRICKS = register("dread_stone_bricks", new BlockDreadBase(false));
    public static final Block DREAD_STONE_BRICKS_STAIRS = register("dread_stone_stairs", new BlockDreadStairs(DREAD_STONE_BRICKS.getDefaultState(), AbstractBlock.Settings.create().strength(-1.0F, 3600000.0F)));
    public static final BlockDreadBase DREAD_STONE_BRICKS_CHISELED = register("dread_stone_bricks_chiseled", new BlockDreadBase(false));
    public static final BlockDreadBase DREAD_STONE_BRICKS_CRACKED = register("dread_stone_bricks_cracked", new BlockDreadBase(false));
    public static final BlockDreadBase DREAD_STONE_BRICKS_MOSSY = register("dread_stone_bricks_mossy", new BlockDreadBase(false));
    public static final BlockDreadBase DREAD_STONE_TILE = register("dread_stone_tile", new BlockDreadBase(false));
    ...
    public static final Block DREAD_STONE_BRICKS_SLAB = register("dread_stone_slab", new BlockDreadSlab(AbstractBlock.Settings.create().mapColor(MapColor.STONE_GRAY).strength(10F, 10000F)));
    public static final Block DREADWOOD_LOG = register("dreadwood_log", new BlockDreadWoodLog());
    public static final BlockDreadBase DREADWOOD_PLANKS = register("dreadwood_planks", new BlockDreadBase(true));
