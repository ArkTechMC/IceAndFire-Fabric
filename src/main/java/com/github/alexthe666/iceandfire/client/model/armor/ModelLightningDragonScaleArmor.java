...
public class ModelLightningDragonScaleArmor extends ArmorModelBase {
    ...
    public static ModelData getModelData(Dilation deformation, float offset) {
        ...
        partdefinition.getChild("head").addChild("HornR", ModelPartBuilder.create().uv(48, 44).cuboid(-1.0F, -0.5F, 0.0F, 2, 3, 5), ModelTransform.of(-3.6F, -8.0F, 0.0F, 0.4363323129985824F, -0.33161255787892263F, -0.19198621771937624F));
        partdefinition.getChild("head").addChild("HornL", ModelPartBuilder.create().uv(48, 44).mirrored().cuboid(-1.0F, -0.5F, 0.0F, 2, 3, 5), ModelTransform.of(3.6F, -8.0F, 0.0F, 0.4363323129985824F, 0.33161255787892263F, 0.19198621771937624F));

        partdefinition.getChild("head").addChild("HornR3", ModelPartBuilder.create().uv(47, 37).mirrored().cuboid(-0.5F, -0.8F, 0.0F, 1, 2, 4), ModelTransform.of(-4.0F, -3.0F, 0.7F, -0.06981317007977318F, -0.4886921905584123F, -0.08726646259971647F));
        partdefinition.getChild("head").addChild("HornL3", ModelPartBuilder.create().uv(47, 37).mirrored().cuboid(-0.5F, -0.8F, 0.0F, 1, 2, 4), ModelTransform.of(4.0F, -3.0F, 0.7F, -0.06981317007977318F, 0.4886921905584123F, 0.08726646259971647F));
        ...
        partdefinition.getChild("head").addChild("HornR4", ModelPartBuilder.create().uv(46, 36).mirrored().cuboid(-0.5F, -0.8F, 0.0F, 1, 2, 5), ModelTransform.of(-4.0F, -5.1F, 0.1F, 0.12217304763960307F, -0.3141592653589793F, -0.03490658503988659F));
        partdefinition.getChild("head").addChild("HornL4", ModelPartBuilder.create().uv(46, 36).mirrored().cuboid(-0.5F, -0.8F, 0.0F, 1, 2, 5), ModelTransform.of(4.0F, -5.1F, -0.1F, 0.12217304763960307F, 0.3141592653589793F, 0.03490658503988659F));

        partdefinition.getChild("head").addChild("Teeth1", ModelPartBuilder.create().uv(6, 34).cuboid(-3.6F, 0.1F, -8.9F, 4, 1, 5), ModelTransform.pivot(0.0F, -6.2F, 0.0F));
        ...
        partdefinition.getChild("head").getChild("HornR").addChild("HornR2", ModelPartBuilder.create().uv(46, 36).mirrored().cuboid(-0.5F, -0.8F, 0.0F, 1, 2, 5), ModelTransform.of(0.0F, 0.3F, 4.5F, -0.07504915783575616F, 0.5009094953223726F, 0.0F));
        partdefinition.getChild("head").getChild("HornL").addChild("HornL2", ModelPartBuilder.create().uv(46, 36).mirrored().cuboid(-0.5F, -0.8F, 0.0F, 1, 2, 5), ModelTransform.of(0.0F, 0.3F, 4.5F, -0.07504915783575616F, -0.5009094953223726F, 0.0F));

        partdefinition.getChild("head").getChild("HeadFront").addChild("Teeth2", ModelPartBuilder.create().uv(6, 34).mirrored().cuboid(-0.4F, 0.1F, -8.9F, 4, 1, 5), ModelTransform.pivot(0.0F, -1.0F, 0.0F));

        partdefinition.getChild("head").getChild("Jaw").addChild("Teeth3", ModelPartBuilder.create().uv(6, 34).cuboid(-3.6F, 0.1F, -8.9F, 4, 1, 5), ModelTransform.pivot(0.0F, 3.0F, 1.4F));
        partdefinition.getChild("head").getChild("Jaw").addChild("Teeth4", ModelPartBuilder.create().uv(6, 34).mirrored().cuboid(-0.4F, 0.1F, -8.9F, 4, 1, 5), ModelTransform.pivot(0.0F, 3.0F, 1.4F));
