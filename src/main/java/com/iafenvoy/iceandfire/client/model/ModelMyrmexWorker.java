...
public class ModelMyrmexWorker extends ModelMyrmexBase {
    ...
    public Iterable<AdvancedModelBox> getAllParts() {
        return ImmutableList.of(this.Body2, this.Body3, this.Body1, this.legTopR2, this.legTopR2_1, this.Body4, this.legTopR3, this.legTopR3_1,
                ...
                this.legTopR1, this.legTopR1_1, this.HeadBase, this.EyeR, this.MandibleL, this.MandibleR, this.EyeL, this.legMidR1, this.legBottomR1,
                this.legMidR1_1, this.legBottomR1_1, this.legMidR2, this.legBottomR2, this.legMidR2_1, this.legBottomR2_1);
    }

    public void animate(IAnimatedEntity entity, float f, float f1, float f2, float f3, float f4, float f5) {
        this.animator.update(entity);
        if (this.animator.setAnimation(EntityMyrmexWorker.ANIMATION_BITE)) {
            this.animator.startKeyframe(5);
            ModelUtils.rotate(this.animator, this.Neck1, -50, 0, 0);
            ModelUtils.rotate(this.animator, this.HeadBase, 50, 0, 0);
            ModelUtils.rotate(this.animator, this.MandibleR, 0, 25, 0);
            ModelUtils.rotate(this.animator, this.MandibleL, 0, -25, 0);
            this.animator.endKeyframe();
            this.animator.startKeyframe(5);
            ModelUtils.rotate(this.animator, this.Neck1, 30, 0, 0);
            ModelUtils.rotate(this.animator, this.HeadBase, -30, 0, 0);
            ModelUtils.rotate(this.animator, this.MandibleR, 0, -45, 0);
            ModelUtils.rotate(this.animator, this.MandibleL, 0, 45, 0);
            this.animator.endKeyframe();
            this.animator.resetKeyframe(5);
        }
        if (this.animator.setAnimation(EntityMyrmexWorker.ANIMATION_STING)) {
            this.animator.startKeyframe(5);
    ...
    public void setAngles(Entity entity, float limbAngle, float limbDistance, float animationProgress, float headYaw, float headPitch) {
        ...
        this.swing(this.MandibleR, speed_idle, degree_idle * -0.5F, false, 1, 0.2F, animationProgress, 1);
        this.swing(this.MandibleL, speed_idle, degree_idle * -0.5F, true, 1, 0.2F, animationProgress, 1);
