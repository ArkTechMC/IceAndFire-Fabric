...
public class VanillaTabulaModel implements UnbakedModel {
    ...
    public VanillaTabulaModel(TabulaModelContainer model, SpriteIdentifier particle, ImmutableList<SpriteIdentifier> textures, ImmutableMap<ModelTransformationMode, AffineTransformation> transforms) {
        this.model = model;
    ...
    @Override
    public void setParents(Function<Identifier, UnbakedModel> p_119538_) {

    }

    @org.jetbrains.annotations.Nullable
    @Override
    public BakedModel bake(Baker p_250133_, Function<SpriteIdentifier, Sprite> p_119535_, ModelBakeSettings p_119536_, Identifier p_119537_) {
        return null;
    }
