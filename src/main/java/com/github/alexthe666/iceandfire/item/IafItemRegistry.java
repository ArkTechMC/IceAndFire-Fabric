...
public class IafItemRegistry {
    ...
    public static LazyRegistrar<Item> ITEMS = LazyRegistrar.create(Registries.ITEM, IceAndFire.MOD_ID);
    ...
    public static Item.Settings defaultBuilder() {
        return new Item.Settings()/*.tab(IceAndFire.TAB_ITEMS)*/;
    }

    public static Item.Settings unstackable() {
    ...
    public static void registerItems(NewRegistryEvent event) {
        ...
        registerItem("spawn_egg_ice_dragon", () -> new SpawnEggItem(IafEntityRegistry.ICE_DRAGON.get(), 0XB5DDFB, 0X7EBAF0, new Item.Settings()/*.tab(IceAndFire.TAB_ITEMS)*/));
        registerItem("spawn_egg_lightning_dragon", () -> new SpawnEggItem(IafEntityRegistry.LIGHTNING_DRAGON.get(), 0X422367, 0X725691, new Item.Settings()/*.tab(IceAndFire.TAB_ITEMS)*/));
        registerItem("spawn_egg_hippogryph", () -> new SpawnEggItem(IafEntityRegistry.HIPPOGRYPH.get(), 0XD8D8D8, 0XD1B55D, new Item.Settings()/*.tab(IceAndFire.TAB_ITEMS)*/));
        registerItem("spawn_egg_gorgon", () -> new SpawnEggItem(IafEntityRegistry.GORGON.get(), 0XD0D99F, 0X684530, new Item.Settings()/*.tab(IceAndFire.TAB_ITEMS)*/));
        registerItem("spawn_egg_pixie", () -> new SpawnEggItem(IafEntityRegistry.PIXIE.get(), 0XFF7F89, 0XE2CCE2, new Item.Settings()/*.tab(IceAndFire.TAB_ITEMS)*/));
        registerItem("spawn_egg_cyclops", () -> new SpawnEggItem(IafEntityRegistry.CYCLOPS.get(), 0XB0826E, 0X3A1F0F, new Item.Settings()/*.tab(IceAndFire.TAB_ITEMS)*/));
        registerItem("spawn_egg_siren", () -> new SpawnEggItem(IafEntityRegistry.SIREN.get(), 0X8EE6CA, 0XF2DFC8, new Item.Settings()/*.tab(IceAndFire.TAB_ITEMS)*/));
        registerItem("spawn_egg_hippocampus", () -> new SpawnEggItem(IafEntityRegistry.HIPPOCAMPUS.get(), 0X4491C7, 0X4FC56B, new Item.Settings()/*.tab(IceAndFire.TAB_ITEMS)*/));
        registerItem("spawn_egg_death_worm", () -> new SpawnEggItem(IafEntityRegistry.DEATH_WORM.get(), 0XD1CDA3, 0X423A3A, new Item.Settings()/*.tab(IceAndFire.TAB_ITEMS)*/));
        registerItem("spawn_egg_cockatrice", () -> new SpawnEggItem(IafEntityRegistry.COCKATRICE.get(), 0X8F5005, 0X4F5A23, new Item.Settings()/*.tab(IceAndFire.TAB_ITEMS)*/));
        registerItem("spawn_egg_stymphalian_bird", () -> new SpawnEggItem(IafEntityRegistry.STYMPHALIAN_BIRD.get(), 0X744F37, 0X9E6C4B, new Item.Settings()/*.tab(IceAndFire.TAB_ITEMS)*/));
        registerItem("spawn_egg_troll", () -> new SpawnEggItem(IafEntityRegistry.TROLL.get(), 0X3D413D, 0X58433A, new Item.Settings()/*.tab(IceAndFire.TAB_ITEMS)*/));
        registerItem("spawn_egg_myrmex_worker", () -> new SpawnEggItem(IafEntityRegistry.MYRMEX_WORKER.get(), 0XA16026, 0X594520, new Item.Settings()/*.tab(IceAndFire.TAB_ITEMS)*/));
        registerItem("spawn_egg_myrmex_soldier", () -> new SpawnEggItem(IafEntityRegistry.MYRMEX_SOLDIER.get(), 0XA16026, 0X7D622D, new Item.Settings()/*.tab(IceAndFire.TAB_ITEMS)*/));
        registerItem("spawn_egg_myrmex_sentinel", () -> new SpawnEggItem(IafEntityRegistry.MYRMEX_SENTINEL.get(), 0XA16026, 0XA27F3A, new Item.Settings()/*.tab(IceAndFire.TAB_ITEMS)*/));
        registerItem("spawn_egg_myrmex_royal", () -> new SpawnEggItem(IafEntityRegistry.MYRMEX_ROYAL.get(), 0XA16026, 0XC79B48, new Item.Settings()/*.tab(IceAndFire.TAB_ITEMS)*/));
        registerItem("spawn_egg_myrmex_queen", () -> new SpawnEggItem(IafEntityRegistry.MYRMEX_QUEEN.get(), 0XA16026, 0XECB855, new Item.Settings()/*.tab(IceAndFire.TAB_ITEMS)*/));
        registerItem("spawn_egg_amphithere", () -> new SpawnEggItem(IafEntityRegistry.AMPHITHERE.get(), 0X597535, 0X00AA98, new Item.Settings()/*.tab(IceAndFire.TAB_ITEMS)*/));
        registerItem("spawn_egg_sea_serpent", () -> new SpawnEggItem(IafEntityRegistry.SEA_SERPENT.get(), 0X008299, 0XC5E6E7, new Item.Settings()/*.tab(IceAndFire.TAB_ITEMS)*/));
        registerItem("spawn_egg_dread_thrall", () -> new SpawnEggItem(IafEntityRegistry.DREAD_THRALL.get(), 0XE0E6E6, 0X00FFFF, new Item.Settings()/*.tab(IceAndFire.TAB_ITEMS)*/));
        registerItem("spawn_egg_dread_ghoul", () -> new SpawnEggItem(IafEntityRegistry.DREAD_GHOUL.get(), 0XE0E6E6, 0X7B838A, new Item.Settings()/*.tab(IceAndFire.TAB_ITEMS)*/));
        registerItem("spawn_egg_dread_beast", () -> new SpawnEggItem(IafEntityRegistry.DREAD_BEAST.get(), 0XE0E6E6, 0X38373C, new Item.Settings()/*.tab(IceAndFire.TAB_ITEMS)*/));
        registerItem("spawn_egg_dread_scuttler", () -> new SpawnEggItem(IafEntityRegistry.DREAD_SCUTTLER.get(), 0XE0E6E6, 0X4D5667, new Item.Settings()/*.tab(IceAndFire.TAB_ITEMS)*/));
        registerItem("spawn_egg_lich", () -> new SpawnEggItem(IafEntityRegistry.DREAD_LICH.get(), 0XE0E6E6, 0X274860, new Item.Settings()/*.tab(IceAndFire.TAB_ITEMS)*/));
        registerItem("spawn_egg_dread_knight", () -> new SpawnEggItem(IafEntityRegistry.DREAD_KNIGHT.get(), 0XE0E6E6, 0X4A6C6E, new Item.Settings()/*.tab(IceAndFire.TAB_ITEMS)*/));
        registerItem("spawn_egg_dread_horse", () -> new SpawnEggItem(IafEntityRegistry.DREAD_HORSE.get(), 0XE0E6E6, 0XACACAC, new Item.Settings()/*.tab(IceAndFire.TAB_ITEMS)*/));
        registerItem("spawn_egg_hydra", () -> new SpawnEggItem(IafEntityRegistry.HYDRA.get(), 0X8B8B78, 0X2E372B, new Item.Settings()/*.tab(IceAndFire.TAB_ITEMS)*/));
        registerItem("spawn_egg_ghost", () -> new SpawnEggItem(IafEntityRegistry.GHOST.get(), 0XB9EDB8, 0X73B276, new Item.Settings()/*.tab(IceAndFire.TAB_ITEMS)*/));
    }
    ...
    */
    ...
    public static void setRepairMaterials(final RegisterEvent event) {
        ...
        IafItemRegistry.FIRE_DRAGONBONE_TOOL_MATERIAL.setRepairMaterial(Ingredient.ofItems(IafItemRegistry.DRAGON_BONE.get()));
        IafItemRegistry.ICE_DRAGONBONE_TOOL_MATERIAL.setRepairMaterial(Ingredient.ofItems(IafItemRegistry.DRAGON_BONE.get()));
        IafItemRegistry.LIGHTNING_DRAGONBONE_TOOL_MATERIAL.setRepairMaterial(Ingredient.ofItems(IafItemRegistry.DRAGON_BONE.get()));
        for (EnumDragonArmor armor : EnumDragonArmor.values()) {
            armor.armorMaterial.setRepairMaterial(Ingredient.ofItems(EnumDragonArmor.getScaleItem(armor)));
        }
        IafItemRegistry.DRAGONSTEEL_FIRE_ARMOR_MATERIAL.setRepairMaterial(Ingredient.ofItems(IafItemRegistry.DRAGONSTEEL_FIRE_INGOT.get()));
        IafItemRegistry.DRAGONSTEEL_ICE_ARMOR_MATERIAL.setRepairMaterial(Ingredient.ofItems(IafItemRegistry.DRAGONSTEEL_ICE_INGOT.get()));
        IafItemRegistry.DRAGONSTEEL_LIGHTNING_ARMOR_MATERIAL.setRepairMaterial(Ingredient.ofItems(IafItemRegistry.DRAGONSTEEL_LIGHTNING_INGOT.get()));
        IafItemRegistry.SHEEP_ARMOR_MATERIAL.setRepairMaterial(Ingredient.ofItems(Blocks.WHITE_WOOL));
        IafItemRegistry.EARPLUGS_ARMOR_MATERIAL.setRepairMaterial(Ingredient.ofItems(Blocks.OAK_BUTTON));
        IafItemRegistry.DEATHWORM_0_ARMOR_MATERIAL.setRepairMaterial(Ingredient.ofItems(IafItemRegistry.DEATH_WORM_CHITIN_YELLOW.get()));
        IafItemRegistry.DEATHWORM_1_ARMOR_MATERIAL.setRepairMaterial(Ingredient.ofItems(IafItemRegistry.DEATH_WORM_CHITIN_RED.get()));
        IafItemRegistry.DEATHWORM_2_ARMOR_MATERIAL.setRepairMaterial(Ingredient.ofItems(IafItemRegistry.DEATH_WORM_CHITIN_WHITE.get()));
        IafItemRegistry.TROLL_WEAPON_TOOL_MATERIAL.setRepairMaterial(Ingredient.ofItems(Items.STONE));
        IafItemRegistry.TROLL_MOUNTAIN_ARMOR_MATERIAL.setRepairMaterial(Ingredient.ofItems(EnumTroll.MOUNTAIN.leather.get()));
        IafItemRegistry.TROLL_FOREST_ARMOR_MATERIAL.setRepairMaterial(Ingredient.ofItems(EnumTroll.FOREST.leather.get()));
        IafItemRegistry.TROLL_FROST_ARMOR_MATERIAL.setRepairMaterial(Ingredient.ofItems(EnumTroll.FROST.leather.get()));
        IafItemRegistry.HIPPOGRYPH_SWORD_TOOL_MATERIAL.setRepairMaterial(Ingredient.ofItems(IafItemRegistry.HIPPOGRYPH_TALON.get()));
        IafItemRegistry.HIPPOCAMPUS_SWORD_TOOL_MATERIAL.setRepairMaterial(Ingredient.ofItems(IafItemRegistry.SHINY_SCALES.get()));
        IafItemRegistry.AMPHITHERE_SWORD_TOOL_MATERIAL.setRepairMaterial(Ingredient.ofItems(IafItemRegistry.AMPHITHERE_FEATHER.get()));
        IafItemRegistry.STYMHALIAN_SWORD_TOOL_MATERIAL.setRepairMaterial(Ingredient.ofItems(IafItemRegistry.STYMPHALIAN_BIRD_FEATHER.get()));
        IafItemRegistry.MYRMEX_CHITIN_TOOL_MATERIAL.setRepairMaterial(Ingredient.ofItems(IafItemRegistry.MYRMEX_DESERT_CHITIN.get()));
        IafItemRegistry.MYRMEX_DESERT_ARMOR_MATERIAL.setRepairMaterial(Ingredient.ofItems(IafItemRegistry.MYRMEX_DESERT_CHITIN.get()));
        IafItemRegistry.MYRMEX_JUNGLE_ARMOR_MATERIAL.setRepairMaterial(Ingredient.ofItems(IafItemRegistry.MYRMEX_JUNGLE_CHITIN.get()));
        IafItemRegistry.DREAD_SWORD_TOOL_MATERIAL.setRepairMaterial(Ingredient.ofItems(IafItemRegistry.DREAD_SHARD.get()));
        IafItemRegistry.DREAD_KNIGHT_TOOL_MATERIAL.setRepairMaterial(Ingredient.ofItems(IafItemRegistry.DREAD_SHARD.get()));
