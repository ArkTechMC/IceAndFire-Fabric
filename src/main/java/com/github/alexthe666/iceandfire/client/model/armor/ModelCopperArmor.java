...
public class ModelCopperArmor extends ArmorModelBase {
    ...
    public static ModelData getModelData(Dilation deformation, float offset) {
        ...
        partdefinition.getChild("head").addChild("crest", ModelPartBuilder.create().uv(23, 31).cuboid(0.0F, -7.5F, -9.0F, 0, 16, 14), ModelTransform.pivot(0.0F, -7.6F, 2.6F));
        partdefinition.getChild("head").addChild("facePlate", ModelPartBuilder.create().uv(34, 32).cuboid(-4.5F, -8.2F, -4.01F, 9, 10, 1), ModelTransform.pivot(0.0F, 0.0F, 0.0F));

        partdefinition.getChild("right_leg").addChild("robeLowerRight", ModelPartBuilder.create().uv(0, 51).cuboid(-2.1F, 0.0F, -2.5F, 4, 8, 5).mirrored(), ModelTransform.pivot(0.0F, -0.2F, 0.0F));
        partdefinition.getChild("left_leg").addChild("robeLowerLeft", ModelPartBuilder.create().uv(0, 51).cuboid(-1.9F, 0.0F, -2.5F, 4, 8, 5), ModelTransform.pivot(0.0F, -0.2F, 0.0F));
