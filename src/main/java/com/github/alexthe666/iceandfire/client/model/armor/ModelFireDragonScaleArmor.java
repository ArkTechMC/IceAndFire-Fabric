...
public class ModelFireDragonScaleArmor extends ArmorModelBase {
    ...
    public static ModelData getModelData(Dilation deformation, float offset) {
        ...
        partdefinition.getChild("head").getChild("HeadFront").addChild("Teeth1", ModelPartBuilder.create().uv(6, 34).cuboid(-3.6F, 0.1F, -8.9F, 4, 1, 5), ModelTransform.pivot(0.0F, -1.0F, 0.0F));
