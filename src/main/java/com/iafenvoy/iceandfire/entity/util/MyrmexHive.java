...
public class MyrmexHive {
    ...
    public void setWanderRadius(int wanderRadius) {
        this.wanderRadius = Math.min(wanderRadius, IafCommonConfig.INSTANCE.myrmex.maximumWanderRadius.getValue());
    }
    ...
    public boolean repopulate() {
        ...
        return this.numMyrmex < Math.min(IafCommonConfig.INSTANCE.myrmex.colonySize.getValue(), roomCount * 9) && this.reproduces;
    }
