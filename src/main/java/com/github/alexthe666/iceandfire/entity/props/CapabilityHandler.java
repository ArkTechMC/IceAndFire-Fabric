...
public class CapabilityHandler {
    ...
    public static final Identifier ENTITY_DATA = new Identifier(IceAndFire.MOD_ID, "entity_data");
    ...
    public static void onPlayerStartTracking(final PlayerEvent.StartTracking event) {
        if (event.getTarget() instanceof LivingEntity target && event.getEntity() instanceof ServerPlayerEntity serverPlayer) {
    ...
    */
    ...
    public static void syncEntityData(final Entity entity) {
        if (entity.getWorld().isClient() || !(entity instanceof LivingEntity)) {
            return;
        }
