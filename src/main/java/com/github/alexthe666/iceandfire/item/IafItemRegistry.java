...
public class IafItemRegistry {
    ...
    public static final LazyRegistrar<Item> ITEMS = LazyRegistrar.create(Registries.ITEM, IceAndFire.MOD_ID);
    ...
    public static final RegistryObject<Item> DRAGON_BONE = registerItem("dragonbone", ItemDragonBone::new);
    public static final RegistryObject<Item> WITHERBONE = registerItem("witherbone", ItemGeneric::new);
    public static final RegistryObject<Item> FISHING_SPEAR = registerItem("fishing_spear", ItemFishingSpear::new);
    ...
    public static final RegistryObject<Item> DRAGONBONE_ARROW = registerItem("dragonbone_arrow", ItemDragonArrow::new);
    public static final RegistryObject<Item> DRAGON_BOW = registerItem("dragonbone_bow", ItemDragonBow::new);
    ...
    public static final RegistryObject<Item> DRAGON_STAFF = registerItem("dragon_stick", ItemDragonStaff::new);
    public static final RegistryObject<Item> DRAGON_HORN = registerItem("dragon_horn", ItemDragonHorn::new);
    public static final RegistryObject<Item> DRAGON_FLUTE = registerItem("dragon_flute", ItemDragonFlute::new);
    public static final RegistryObject<Item> SUMMONING_CRYSTAL_FIRE = registerItem("summoning_crystal_fire", ItemSummoningCrystal::new);
    public static final RegistryObject<Item> SUMMONING_CRYSTAL_ICE = registerItem("summoning_crystal_ice", ItemSummoningCrystal::new);
    public static final RegistryObject<Item> SUMMONING_CRYSTAL_LIGHTNING = registerItem("summoning_crystal_lightning", ItemSummoningCrystal::new);
    public static final RegistryObject<Item> HIPPOGRYPH_EGG = registerItem("hippogryph_egg", ItemHippogryphEgg::new);
    ...
    public static final RegistryObject<Item> HIPPOGRYPH_SWORD = registerItem("hippogryph_sword", ItemHippogryphSword::new);
    public static final RegistryObject<Item> GORGON_HEAD = registerItem("gorgon_head", ItemGorgonHead::new);
    public static final RegistryObject<Item> STONE_STATUE = registerItem("stone_statue", ItemStoneStatue::new);
    public static final RegistryObject<Item> BLINDFOLD = registerItem("blindfold", ItemBlindfold::new);
    public static final RegistryObject<Item> PIXIE_DUST = registerItem("pixie_dust", ItemPixieDust::new);
    public static final RegistryObject<Item> PIXIE_WINGS = registerItem("pixie_wings", () -> new ItemGeneric(1));
    public static final RegistryObject<Item> PIXIE_WAND = registerItem("pixie_wand", ItemPixieWand::new);
    public static final RegistryObject<Item> AMBROSIA = registerItem("ambrosia", ItemAmbrosia::new);
    public static final RegistryObject<Item> CYCLOPS_EYE = registerItem("cyclops_eye", ItemCyclopsEye::new);
    ...
    public static final RegistryObject<Item> SIREN_FLUTE = registerItem("siren_flute", ItemSirenFlute::new);
    public static final RegistryObject<Item> HIPPOCAMPUS_FIN = registerItem("hippocampus_fin", () -> new ItemGeneric(1));
    public static final RegistryObject<Item> HIPPOCAMPUS_SLAPPER = registerItem("hippocampus_slapper", ItemHippocampusSlapper::new);
    ...
    public static final RegistryObject<Item> DEATHWORM_GAUNTLET_YELLOW = registerItem("deathworm_gauntlet_yellow", ItemDeathwormGauntlet::new);
    public static final RegistryObject<Item> DEATHWORM_GAUNTLET_WHITE = registerItem("deathworm_gauntlet_white", ItemDeathwormGauntlet::new);
    public static final RegistryObject<Item> DEATHWORM_GAUNTLET_RED = registerItem("deathworm_gauntlet_red", ItemDeathwormGauntlet::new);
    public static final RegistryObject<Item> ROTTEN_EGG = registerItem("rotten_egg", ItemRottenEgg::new);
    public static final RegistryObject<Item> COCKATRICE_EYE = registerItem("cockatrice_eye", () -> new ItemGeneric(1));
    public static final RegistryObject<Item> ITEM_COCKATRICE_SCEPTER = registerItem("cockatrice_scepter", ItemCockatriceScepter::new);
    public static final RegistryObject<Item> STYMPHALIAN_BIRD_FEATHER = registerItem("stymphalian_bird_feather", ItemGeneric::new);
    public static final RegistryObject<Item> STYMPHALIAN_ARROW = registerItem("stymphalian_arrow", ItemStymphalianArrow::new);
    public static final RegistryObject<Item> STYMPHALIAN_FEATHER_BUNDLE = registerItem("stymphalian_feather_bundle", ItemStymphalianFeatherBundle::new);
    public static final RegistryObject<Item> STYMPHALIAN_DAGGER = registerItem("stymphalian_bird_dagger", ItemStymphalianDagger::new);
    ...
    public static final RegistryObject<Item> AMPHITHERE_ARROW = registerItem("amphithere_arrow", ItemAmphithereArrow::new);
    public static final RegistryObject<Item> AMPHITHERE_MACUAHUITL = registerItem("amphithere_macuahuitl", ItemAmphithereMacuahuitl::new);
    public static final RegistryObject<Item> SERPENT_FANG = registerItem("sea_serpent_fang", ItemGeneric::new);
    public static final RegistryObject<Item> SEA_SERPENT_ARROW = registerItem("sea_serpent_arrow", ItemSeaSerpentArrow::new);
    ...
    public static final RegistryObject<Item> TIDE_TRIDENT = registerItem("tide_trident", ItemTideTrident::new);
    ...
    public static final RegistryObject<Item> DRAGONSTEEL_FIRE_SWORD = registerItem("dragonsteel_fire_sword", () -> new ItemModSword(createMaterialWithRepairItem(DRAGONSTEEL_FIRE_INGOT.get(), "dragonsteel_tier_fire")));
    public static final RegistryObject<Item> DRAGONSTEEL_FIRE_PICKAXE = registerItem("dragonsteel_fire_pickaxe", () -> new ItemModPickaxe(createMaterialWithRepairItem(DRAGONSTEEL_FIRE_INGOT.get(), "dragonsteel_tier_fire")));
    public static final RegistryObject<Item> DRAGONSTEEL_FIRE_AXE = registerItem("dragonsteel_fire_axe", () -> new ItemModAxe(createMaterialWithRepairItem(DRAGONSTEEL_FIRE_INGOT.get(), "dragonsteel_tier_fire")));
    public static final RegistryObject<Item> DRAGONSTEEL_FIRE_SHOVEL = registerItem("dragonsteel_fire_shovel", () -> new ItemModShovel(createMaterialWithRepairItem(DRAGONSTEEL_FIRE_INGOT.get(), "dragonsteel_tier_fire")));
    public static final RegistryObject<Item> DRAGONSTEEL_FIRE_HOE = registerItem("dragonsteel_fire_hoe", () -> new ItemModHoe(createMaterialWithRepairItem(DRAGONSTEEL_FIRE_INGOT.get(), "dragonsteel_tier_fire")));
    ...
    public static final RegistryObject<Item> DRAGONSTEEL_ICE_SWORD = registerItem("dragonsteel_ice_sword", () -> new ItemModSword(createMaterialWithRepairItem(DRAGONSTEEL_ICE_INGOT.get(), "dragonsteel_tier_ice")));
    public static final RegistryObject<Item> DRAGONSTEEL_ICE_PICKAXE = registerItem("dragonsteel_ice_pickaxe", () -> new ItemModPickaxe(createMaterialWithRepairItem(DRAGONSTEEL_ICE_INGOT.get(), "dragonsteel_tier_ice")));
    public static final RegistryObject<Item> DRAGONSTEEL_ICE_AXE = registerItem("dragonsteel_ice_axe", () -> new ItemModAxe(createMaterialWithRepairItem(DRAGONSTEEL_ICE_INGOT.get(), "dragonsteel_tier_ice")));
    public static final RegistryObject<Item> DRAGONSTEEL_ICE_SHOVEL = registerItem("dragonsteel_ice_shovel", () -> new ItemModShovel(createMaterialWithRepairItem(DRAGONSTEEL_ICE_INGOT.get(), "dragonsteel_tier_ice")));
    public static final RegistryObject<Item> DRAGONSTEEL_ICE_HOE = registerItem("dragonsteel_ice_hoe", () -> new ItemModHoe(createMaterialWithRepairItem(DRAGONSTEEL_ICE_INGOT.get(), "dragonsteel_tier_ice")));
    ...
    public static final RegistryObject<Item> DRAGONSTEEL_LIGHTNING_SWORD = registerItem("dragonsteel_lightning_sword", () -> new ItemModSword(createMaterialWithRepairItem(DRAGONSTEEL_LIGHTNING_INGOT.get(), "dragonsteel_tier_lightning")));
    public static final RegistryObject<Item> DRAGONSTEEL_LIGHTNING_PICKAXE = registerItem("dragonsteel_lightning_pickaxe", () -> new ItemModPickaxe(createMaterialWithRepairItem(DRAGONSTEEL_LIGHTNING_INGOT.get(), "dragonsteel_tier_lightning")));
    public static final RegistryObject<Item> DRAGONSTEEL_LIGHTNING_AXE = registerItem("dragonsteel_lightning_axe", () -> new ItemModAxe(createMaterialWithRepairItem(DRAGONSTEEL_LIGHTNING_INGOT.get(), "dragonsteel_tier_lightning")));
    public static final RegistryObject<Item> DRAGONSTEEL_LIGHTNING_SHOVEL = registerItem("dragonsteel_lightning_shovel", () -> new ItemModShovel(createMaterialWithRepairItem(DRAGONSTEEL_LIGHTNING_INGOT.get(), "dragonsteel_tier_lightning")));
    public static final RegistryObject<Item> DRAGONSTEEL_LIGHTNING_HOE = registerItem("dragonsteel_lightning_hoe", () -> new ItemModHoe(createMaterialWithRepairItem(DRAGONSTEEL_LIGHTNING_INGOT.get(), "dragonsteel_tier_lightning")));
    ...
    public static final RegistryObject<Item> LICH_STAFF = registerItem("lich_staff", ItemLichStaff::new);
    public static final RegistryObject<Item> DREAD_QUEEN_SWORD = registerItem("dread_queen_sword", () -> new ItemModSword(createMaterialWithRepairItem(Items.AIR, "dragonsteel_tier_dread_queen")));
    public static final RegistryObject<Item> DREAD_QUEEN_STAFF = registerItem("dread_queen_staff", ItemDreadQueenStaff::new);
    ...
    public static final RegistryObject<Item> HYDRA_HEART = registerItem("hydra_heart", ItemHydraHeart::new);
    public static final RegistryObject<Item> HYDRA_ARROW = registerItem("hydra_arrow", ItemHydraArrow::new);
    public static final RegistryObject<Item> CANNOLI = registerItem("cannoli", ItemCannoli::new, false);
    ...
    public static final RegistryObject<Item> GHOST_SWORD = registerItem("ghost_sword", ItemGhostSword::new);
