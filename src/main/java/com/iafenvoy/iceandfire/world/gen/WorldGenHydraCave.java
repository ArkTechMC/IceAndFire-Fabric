...
public class WorldGenHydraCave extends Feature<DefaultFeatureConfig> implements TypedFeature {
    ...
    public boolean generate(FeatureContext<DefaultFeatureConfig> context) {
        ...
        if (rand.nextDouble() >= IafCommonConfig.INSTANCE.hydra.spawnChance.getValue() || !IafFeatures.isFarEnoughFromSpawn(worldIn, position) || !IafFeatures.isFarEnoughFromDangerousGen(worldIn, position, this.getId())) {
            return false;
        }
