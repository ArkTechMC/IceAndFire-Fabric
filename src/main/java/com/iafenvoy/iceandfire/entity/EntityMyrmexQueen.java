...
public class EntityMyrmexQueen extends EntityMyrmexBase {
    ...
    public static DefaultAttributeContainer.Builder bakeAttributes() {
        return MobEntity.createMobAttributes()
                ...
                //ATTACK
                .add(EntityAttributes.GENERIC_ATTACK_DAMAGE, IafConfig.getInstance().myrmex.baseAttackStrength * 3.5D)
                //FOLLOW RANGE
    ...
    public void tickMovement() {
        ...
        if (!this.getWorld().isClient && this.eggTicks > IafConfig.getInstance().myrmex.pregnantTicks && this.getHive() == null || !this.getWorld().isClient && this.getHive() != null && this.getHive().repopulate() && this.eggTicks > IafConfig.getInstance().myrmex.pregnantTicks) {
            float radius = -5.25F;
    ...
    public void setConfigurableAttributes() {
        this.getAttributeInstance(EntityAttributes.GENERIC_ATTACK_DAMAGE).setBaseValue(IafConfig.getInstance().myrmex.baseAttackStrength * 3.5D);
    }
